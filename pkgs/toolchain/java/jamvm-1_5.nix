        ...
        "steps" = [
          {
            ...
            "stdout" = {
              "exact" = "jamvm-1_5 operation passed\n";
            };
          }
        ];
      };
