##! August 2013 Kotlin JVM compiler stage with textual builtins.
{
  mkDerivation,
  fetchgit,
  fetchurl,
  ...
  source = fetchgit {
    ...
    rev = "450d6cad3b68c50cc850fbbdac1d87759d273bef";
    name = "kotlin-2013-august-textual-compiler-source-only";
    hash = "sha256-qyWFdMabXBRqVOeupDpCjRI548CTsA0w9ldoDEMYohw=";
...
in
  mkDerivation {
    ...
    meta = {
      description = "August 2013 Kotlin JVM compiler built from Java sources with textual builtins";
