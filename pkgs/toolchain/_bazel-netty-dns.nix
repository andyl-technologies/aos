##! Netty DNS codec and resolver Java modules built from source.
{
  mkDerivation,
  fetchurl,
  buildPackages,
  ...
  archives = [
    {
      name = "codec-dns";
      hash = "sha256-OQQxv1DNvcFuOZnSI/UEjASd5eWNqRbAZkZiJyYZwiA=";
    }
    {
      name = "resolver-dns";
      hash = "sha256-C/DVN6fo4roih0EFJgh0XIWIQpOK/c3G/dwIIeeSo/Q=";
    }
  ];
  sources =
    builtins.map (
