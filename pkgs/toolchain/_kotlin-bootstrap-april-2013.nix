##! April 2013 Kotlin JVM compiler stage built from Java sources.
{
  mkDerivation,
  fetchgit,
  fetchurl,
  ...
  source = fetchgit {
    ...
    rev = "b88981f6782713a7c117e5b15bb0c254990cdaad";
    name = "kotlin-2013-april-java-compiler-source-only";
    hash = "sha256-3qfVKB2KVXpj4bGbsLDjr4Xtt9ekUYlGx3VKK7GSLUc=";
...
in
  mkDerivation {
    ...
    meta = {
      description = "April 2013 Kotlin JVM compiler built from Java sources";
