...
in
  mkDerivation {
    ...
    src = fetchgit {
      ...
      hash = "sha256-soIvSVCAjdRxrGLw0JM5QP1C879QeZk3AR6VtNRk26w=";
      deepClone = true;
    ...
    phases = [
      ...
      }
      {
        ...
        script = ''
          ...
          for input in "$native"/*.c source/jni-util/netty_jni_util.c; do
        ...
        script = ''
          ...
          ${
            ...
            then ''
              ...
              JAVA
              classes=${bazelNettyTcnativeClasses}/share/java/netty-tcnative-classes-${version}.jar
