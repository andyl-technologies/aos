##! January 2013 Kotlin JVM compiler stage built from Java sources.
{
  mkDerivation,
  fetchgit,
  fetchurl,
  ...
  source = fetchgit {
    ...
    rev = "79e27f2d904f60ea654973e64fd7f26f2192159a";
    name = "kotlin-2013-january-java-compiler-source-only";
    hash = "sha256-0WLdZS6aCKU96oz8YSOSQrQM/LG1czuMyutftivSBGU=";
...
in
  mkDerivation {
    ...
    meta = {
      description = "January 2013 Kotlin JVM compiler built from Java sources";
