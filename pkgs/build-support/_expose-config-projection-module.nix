##! Declares and evaluates one package's generated expose configuration.
##!
##! Source and registry evaluation call this same module constructor. The
##! serialized schema is transport data, rather than a second implementation.
{schema}: {
  config,
  lib,
  ...
