...
| `aos:store:replica` | Provider record | Short (1 min) | None | Active replicator | [replication.md](replication.md#protocol) |
| `aos:store:upload` | Provider record | Short (1 min) | None | Upload acceptor | [store-upload.md](store-upload.md) |
| `aos:store:fetch` | Provider record | Short (1 min) | None | Fetch acceptor | [fetch.md](fetch.md#protocol) |
...
| `aos:workflow:runners` | Provider record | Short (1 min) | None | Workflow run acceptor | [workflow.md](workflow.md) |
...
| `aos/auth/token/issue` | `IssuanceNotice` | UCAN issuance (optional) | [auth.md](auth.md#protocol) |
| `aos/store/publish` | `StorePublish` | New store object | [store.md](store.md#protocol) |
| `aos/store/replicate` | `ReplicateMessage` | Replicator coordination | [replication.md](replication.md#protocol) |
| `aos/store/purge` | `StorePurge` | Store object purge | [replication.md](replication.md#protocol) |
...
| `/aos/store/fetch/1.0.0` | `StoreFetchRequest` | stream of `StoreFetchStatus` | Fetch FOD from upstream URLs | [fetch.md](fetch.md#protocol) |
...
| `/aos/workflow/run/1.0.0` | `WorkflowRunRequest` | stream of `WorkflowRunStatus` | Submit workflow to bootstrap node | [workflow.md](workflow.md#protocol) |
| `/aos/workflow/info/1.0.0` | `WorkflowInfoRequest` | `WorkflowInfoResponse` | Fetch workflow state | [workflow.md](workflow.md#protocol) |
...
| `/aos/workflow/list/1.0.0` | `WorkflowListRequest` | `WorkflowListResponse` | List workflows (paginated) | [workflow.md](workflow.md#protocol) |
