# Tutorial: Build and boot an AOS server
...
policy, or static networking. Continue with [Customize AOS](configuration.md),
then read [Install an image](installation.md) before deploying the disk outside
this disposable VM.
