...
retained AOSSMT01 Snapshot metadata. These are nonauthorizing observations.
...
| Pool GUID | Bracketed `zpool list` probes | A protected Storage-owned pool-GUID binding; the current selector constrains the expected value |
