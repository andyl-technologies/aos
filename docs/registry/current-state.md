...
| `apr sign TAG --key KEY` | re-signs an existing release tag with `git tag -s -f` (`registry_ops.rs:1747-1762`) | commit signing retired; refreshes dumb-HTTP object indexes |
