# RFC-0012: Signal-driven, cross-domain fault modeling for Crucible
...
- [`CombinedFaults`](../../../crates/crucible/src/model/topology_faults.rs)
  ...
  rules.
- [`FaultPlanEntry`](../../../crates/crucible/src/model/plan_properties.rs)
  identifies the authoring and runtime path that the implementation removes;
  its tests provide behavior examples but do not create a compatibility
  obligation for the replacement schema.
...
event-log, checkpoint, and search contracts. RFC-0012 supersedes RFC-0010's
