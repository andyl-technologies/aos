...
| --- | --- | --- |
| One standard typed module vocabulary | [`lib/abilities/module.nix`](../../../lib/abilities/module.nix), [`lib/abilities/types.nix`](../../../lib/abilities/types.nix), and the provider-neutral interfaces in [`lib/abilities/interfaces/`](../../../lib/abilities/interfaces/) | [`tests/abilities/interface.nix`](../../../tests/abilities/interface.nix) and [`tests/abilities/authoring-conformance.nix`](../../../tests/abilities/authoring-conformance.nix) |
...
| Provider-neutral service features compose independently | [`lib/abilities/interfaces/service-management.nix`](../../../lib/abilities/interfaces/service-management.nix), [`lib/abilities/interfaces/service-policy.nix`](../../../lib/abilities/interfaces/service-policy.nix), and their shared service types | [`tests/abilities/service-features.nix`](../../../tests/abilities/service-features.nix), [`tests/abilities/service-management.nix`](../../../tests/abilities/service-management.nix), and the package-specific service checks in [`tests/abilities/`](../../../tests/abilities/) |
...
| Resource lifetimes and revisions are semantic | Lifetime types and fixed-point propagation in [`lib/abilities/types.nix`](../../../lib/abilities/types.nix) and [`lib/abilities/composition-driver.nix`](../../../lib/abilities/composition-driver.nix); centralized revision derivation in [`crates/aos-ability-plan/src/source_stage.rs`](../../../crates/aos-ability-plan/src/source_stage.rs) | Source-stage tests prove store relocation does not change a revision while semantic artifact or request changes do; transition tests in [`crates/aos-ability-plan/src/transition_tests/`](../../../crates/aos-ability-plan/src/transition_tests/) cover lifetime retention and removal |
...
| Documentation has one signed package projection | [`PackageDocumentationProjection`](../../../crates/aos-doc-model/src/lib.rs), generated package documentation in [`crates/aos-package/src/documentation.rs`](../../../crates/aos-package/src/documentation.rs), and Hub verification in [`crates/aos-hub-core/src/indexer/mod.rs`](../../../crates/aos-hub-core/src/indexer/mod.rs) | [`tests/packages/documentation.nix`](../../../tests/packages/documentation.nix) plus the documentation-model, package CLI/LSP, publication, and Hub indexer tests |
...
| Image, initrd, and package-store handoffs use the same contracts | Stage projection in [`modules/abilities/stages.nix`](../../../modules/abilities/stages.nix), package-owned boot providers, and package-store interfaces in [`lib/abilities/interfaces/`](../../../lib/abilities/interfaces/) | [`tests/abilities/initrd-boot-substrate.nix`](../../../tests/abilities/initrd-boot-substrate.nix), [`tests/abilities/boot-preparation-provider.nix`](../../../tests/abilities/boot-preparation-provider.nix), and [`tests/abilities/package-store-read-view.nix`](../../../tests/abilities/package-store-read-view.nix) |
...
`lib/abilities/_service-types.nix` owns the provider-neutral service vocabulary;
