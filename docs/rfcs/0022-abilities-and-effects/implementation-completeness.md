...
| Provider-neutral service features compose independently | [`lib/abilities/interfaces/service-management.nix`](../../../lib/abilities/interfaces/service-management.nix) and its shared service types | [`tests/abilities/linux-service-features.nix`](../../../tests/abilities/linux-service-features.nix), [`tests/abilities/service-management.nix`](../../../tests/abilities/service-management.nix), and the package-specific service checks in [`tests/abilities/`](../../../tests/abilities/) |
