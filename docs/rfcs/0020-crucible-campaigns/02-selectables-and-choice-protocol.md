...
There is no Schedule V1 compatibility or migration path. Checkpoint V4 carries
the expanded decision grammar while selection-free Checkpoint V3 remains
readable. Domain-specific applied-effect evidence remains in the event log and
