...
| `vm_lifecycle/network_faults.rs` adapter-state encode/decode | Nested opaque checkpoint body independently decoded at version 11, registered as `crucible.production-network-adapter-checkpoint`. |
