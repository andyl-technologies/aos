...
- [ ] **Full systemd hardening baseline** on every generated unit (the
      ...
      includes the namespace, credential, device, proc, clock, hostname,
      capability, syscall, and address-family directives generated by the
      renderer, with `PrivateDevices=` relaxed only for explicit device grants
      and proc isolation skipped for root-equivalent package manifests.
