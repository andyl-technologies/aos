...
- `checks.config-materialize`, `checks.config-parity`, and
  `checks.config-parity-p2` cover deterministic materialization and equality
  between the supported evaluation paths.
