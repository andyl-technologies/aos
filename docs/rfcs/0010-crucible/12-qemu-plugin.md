...
- [x] **T-PLUG-15** Implement the optional coverage hook: a registration-time
  ...
  cover those contracts. The current ABI release-publishes each novel map entry into
...
- [x] **T-PLUG-25** Implement application of `Decision::Preemption`: force the
  ...
  `checks.crucible.phase2.qemuPreemptionInject`. The current shared-memory
