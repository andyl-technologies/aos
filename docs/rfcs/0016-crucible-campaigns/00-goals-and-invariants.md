...
This file establishes the concepts used throughout RFC-0016 and separates the
...
RFC-0016 uses separate terms for operations that share a tree-shaped visual but
