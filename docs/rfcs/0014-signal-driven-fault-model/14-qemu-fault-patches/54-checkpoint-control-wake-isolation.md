# Capability task 0103 — Checkpoint control-wake isolation

## Purpose

Capability task `0103` lets an exact checkpoint hand its already-queued native VM stop to
...
The atomic patch modifies GPL-side `block/crucible-shmem.c`. It changes no
