# Capability task 0091 — Canonical RR genesis cursor

## Purpose

Capability task 0091 makes the formal round-robin cursor API total at the unique exact
...
The case is composed with capability task 0089. Live serialized-owner reads and exact
committed-cursor reads continue unchanged after the first vCPU selection.

## Files and license scope

The atomic patch modifies MIT-licensed `include/plugins/qemu-plugin.h` and
...
4. Focused capability tests must pin exact-boundary, raw-zero, position-zero, and
