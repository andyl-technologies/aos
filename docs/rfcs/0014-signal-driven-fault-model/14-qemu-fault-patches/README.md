...
| [`0114-crucible-authenticate-fault-result-payloads`](65-authenticate-fault-result-payloads.md) | Hash the exact retained payload for every queued fault result, including typed rejections | Transactional result correctness |
| [`0115-crucible-clock-impulse-read-error-policies`](66-clock-impulse-read-error-policies.md) | Persist effective impulse policies in clock VMState and expose deterministic x86 TSC read-error behavior | Guest-clock correctness |
