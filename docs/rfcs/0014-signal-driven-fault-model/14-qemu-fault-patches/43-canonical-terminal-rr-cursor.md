# Capability task 0092 — Canonical terminal RR cursor

## Purpose

Capability task `0092` makes live RR cursor observation agree with the scheduler's
...
already committed cursor. Genesis remains governed by capability task `0091`.
...
2. Atomic-patch source attribution, regeneration, and the pristine-QEMU
   negative must cover the capability specified by capability task `0092`.
