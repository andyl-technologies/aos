...
target in canonical node order; fresh restore installs that policy before its
first control-boundary fingerprint. Exact checkpoint capture rejects staged or
