# Capability task 0134: clock impulse and read-error policies

The atomic patch `crucible-qemu-11.1.1.patch` completes the
...
commit their requested monotonicity or overdue-timer policy. Their typed result
...
Impulse application parses and joins the requested monotonicity and overdue
