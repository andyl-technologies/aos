...
by RFC-0019 §08.2-§08.3. Version 7 adds the scenario-owned selectable catalog
and its declaration/request ceilings specified by RFC-0019 §02. Readers accept
...
authoring tools may render the friendlier RFC-0019 §02.6 projection before
normalization.
