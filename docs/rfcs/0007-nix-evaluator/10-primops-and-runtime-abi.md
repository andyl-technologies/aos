...
- [x] Current runtime symbol registration-preflight precursor:
      ...
      environment-access, forcing, and write-barrier helpers stay in runtime-manifest
      order, and missing
...
- [x] Current runtime symbol ABI-signature preflight precursor:
      ...
      allocation/environment-access/forcing/write-barrier helper ABI metadata with
...
- [x] Current `aos-nix` JIT address-candidate bridge:
      ...
      allocation, environment-access, forcing, and write-barrier helpers, and carries the
