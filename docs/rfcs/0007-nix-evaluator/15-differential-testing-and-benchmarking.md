...
checkpoint, pinned Nix `2.24.12` reports `206 passed, 3 skipped, 0 failed` with
...
- [x] **Conformance runner checkpoint recorded.** The `lang_conformance` runner
      ...
      allowed skip set. The recorded configured checkpoint is `206 passed`,
      `3 skipped`, `0 failed`, with intentional skips named in
