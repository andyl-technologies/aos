...
- **18 Settled + 18 Closed decisions** mean Phase 1 — and the rank-1 cache — are
  ...
  out-of-core memory story, and the cutover gate.)
- **22 Measure-gated** items each carry a buildable default; the harness and
