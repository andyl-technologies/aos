...
and dynamic attrset-node representation decisions, selected list/attr builtin
result representation decisions, and successful `//` update merges with
...
- [x] Current in-process telemetry precursor: `ratchet-value::attrs::telemetry`
      ...
      update merges with syntactic update-chain depth, and exposes the captured
      samples through `EvalOutcome::attr_telemetry`; runtime shape/PIC/HAMT
