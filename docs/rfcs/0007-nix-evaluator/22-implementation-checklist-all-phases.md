...
- [x] Current `aos-nix` runtime-symbol registration preflight bridge:
      ...
      `aos_select_ic`/`aos_apply`/`aos_force` missing-native-address registration gaps, and
...
- [x] Current `aos-nix` runtime-symbol registration plan gate:
      ...
      the owned Nix preflight while the `aos_select_ic`/`aos_apply`/`aos_force` address gaps,
...
- [x] Current uniform runtime-call ABI metadata precursor:
      ...
      call-control apply, environment-access, force/deep-force, and write-barrier helper shapes. The
      ...
      pointer, `Value`, or unit helper returns, and
...
- [x] Current `ratchet-jit` CLIF-signature ABI precursor:
      ...
      attrset select-IC, call-control apply, environment-access, force, and write-barrier helper
...
- [x] Current JIT symbol-declaration preflight precursor:
      ...
      core-owned allocation, attrset select-IC, call-control apply, environment-access,
      ...
      `(rt, Value attrs, SymbolId, InlineCacheSiteId) -> Value`.
      ...
      builtin declaration, allocation, attrset-access, call-control, environment-access,
...
- [x] Current JIT module-readiness precursor:
      ...
      declarations, core-owned allocation, attrset select-IC, environment-access,
      write-barrier, call-control apply, and force/deep-force helper declarations, and stable
...
- [x] Current safe `JITModule` declaration precursor:
      ...
      environment-access, write-barrier, and force/deep-force helper runtime symbol as a
