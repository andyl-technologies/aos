...
- [x] Current force-time inline impure revalidation substrate: trace-backed
  ...
  retention, captured context-bearing string/path free variables, lists/attrs and other composite
