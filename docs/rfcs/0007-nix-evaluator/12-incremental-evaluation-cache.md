...
- [x] Current force-time inline impure revalidation substrate: trace-backed
  ...
  the older public pure lookup remains pure-only. This is in-memory scalar effectful reuse only: source-less raw eval,
