...
| [0016](0016-package-documentation/README.md) | 2026-08-28 | Package documentation as authenticated Nix objects | Implemented and staged in PR #219 |
 ...
 | [0024](0024-terrane/README.md) | 2026-09-25 | Terrane — a distributed, content-addressed, branchable filesystem (standalone specification plus AOS integration) | Proposed (design-only) |
