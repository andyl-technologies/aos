...
| [0004](0004-registry-hub/README.md) | 2026-06-12 | `aos-registry-hub` — a multi-tenant registry management WebUI | Implemented (phases 1–4); Phase 5 (unified async runtime + full Cloudflare parity) Proposed |
