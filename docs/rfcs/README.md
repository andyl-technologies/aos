...
| [0018](0018-maintainer-package-upgrades/README.md) | 2026-09-03 | Local maintainer package upgrades — upstream discovery, deterministic source updates, bounded agent repair, and complete validation | Proposed (design-only) |
