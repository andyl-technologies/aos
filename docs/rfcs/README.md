...
| --- | --- | --- | --- |
| [0001](0001-roles-as-targets.md) | 2026-06-08 | Roles as systemd targets, with sandboxed side-effects | Superseded — content folded into [RFC-0002](0002-package-integration/activation.md) |
| [0002](0002-package-integration/README.md) | 2026-06-08 | AOS Package Sandboxing (`expose` manifests, per-unit sandboxing, preset enablement) | Proposed — phased plan in [`implementation-plan.md`](0002-package-integration/implementation-plan.md) (14/19 decisions resolved; gated on the Decision 17 spike) |
