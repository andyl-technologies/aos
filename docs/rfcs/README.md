...
| [0005](0005-ca-trust-map.md) | 2026-06-12 | The `store/` realisation graph: content-addressed closure validation | Implemented |
...
| [0011](0011-on-host-config-eval/README.md) | 2026-06-25 | On-host, eval-only configuration — generations from downloaded Nix modules | Implemented |
...
| [0022](0022-abilities-and-effects/README.md) | 2026-09-08 | Package abilities, typed dependency consumption, and structured activation effects | Proposed; implementation in progress with checked runtime, native activation, native providers, and shared inspection surfaces |

Numbering is chronological by the date the design entered the tree. Numbers
may be reserved by in-progress proposals outside the default branch.
