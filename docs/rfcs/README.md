...
| [0017](0017-canonical-hub-publishing/README.md) | 2026-09-02 | Canonical AOS Hub publishing — one registry, signed channels, exact-byte promotion, and production key custody | Proposed (design-only; production blockers and maintainer-host runbook defined) |
