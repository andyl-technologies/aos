...
in
  ...
  assert builtins.elem "guest-root-tree-digest-v1:${pkgs.aos-sandbox-guest-root-template}/root-tree-digest" controllerServiceConfig.LoadCredential;
  ...
  assert builtins.length publicServiceConfig.LoadCredential == 19;
  ...
  assert builtins.length ownershipService.serviceConfig.LoadCredential == 18;
