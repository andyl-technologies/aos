...
#define AOS_FIXTURE_BOUNDARY_FINAL_LENGTH 2005U
#define AOS_FIXTURE_BOUNDARY_REMAINDER 3688U
...
enum aos_fixture_fault {
  ...
  AOS_FIXTURE_START_ZERO_NONCE,
  AOS_FIXTURE_START_WRONG_DIGEST,
  AOS_FIXTURE_START_WRONG_CONNECTOR,
  AOS_FIXTURE_START_WRONG_CONNECTOR_INODE,
  AOS_FIXTURE_START_EQUAL_PARENT_CONNECTOR,
  AOS_FIXTURE_START_SAME_PID_DIFFERENT_INODE,
  AOS_FIXTURE_START_DIFFERENT_PID_SAME_INODE,
  AOS_FIXTURE_START_MIN_IDENTITY,
  AOS_FIXTURE_START_MAX_IDENTITY,
  AOS_FIXTURE_CONTROL_RECEIVE_RETRY,
  AOS_FIXTURE_CONTROL_SEND_RETRY,
