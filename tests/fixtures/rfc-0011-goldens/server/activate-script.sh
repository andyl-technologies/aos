...
# per-host /etc writes into the candidate ignition lower. A fresh
# --config-cache avoids colliding with /run/ignition.json written by
# the first-boot fetch.
#
