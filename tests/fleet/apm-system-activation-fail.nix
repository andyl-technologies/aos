  ...
  testScript =
    ...
    ''
      ...
      out = vm.succeed(
          ...
          "set +e\n"
          "HOME=/tmp ${pkgs.aos.packageRuntime}/bin/aos-package-runtime activate-pre-etc-swap "
      ...
      out = vm.succeed(
          ...
          f"plan={plan}\n"
          "set +e\n"
          "HOME=/tmp ${pkgs.aos.packageRuntime}/bin/aos-package-runtime activate-post-etc-swap --plan=\"$plan\" "
