{
  ...
  failures =
    failuresFor "crates/crucible-shmem/src/lib.rs" shmemLib [
      ...
      {
        label = "node slot advance stop-condition Rust static assertion";
        needle = "const _: () = assert!(NODE_SLOT_ADVANCE_STOP_CONDITION_OFFSET == 39);";
      }
      {
      ...
      {
        label = "node slot advance publication sequence Rust static assertion";
        needle = "const _: () = assert!(NODE_SLOT_ADVANCE_PUBLICATION_SEQUENCE_OFFSET == 208);";
      }
      {
        label = "node slot remaining padding Rust static assertion";
        needle = "const _: () = assert!(NODE_SLOT_PAD4_OFFSET == 216);";
      }
      {
    ...
    ++ failuresFor "crates/crucible-shmem/include/crucible_shmem_abi.h" generatedHeader [
      ...
      {
        label = "node slot advance stop-condition offset static assert";
        needle = "offsetof(crucible_shmem_node_slot, advance_stop_condition) == CRUCIBLE_SHMEM_NODE_SLOT_ADVANCE_STOP_CONDITION_OFFSET";
      }
      {
      ...
      {
        label = "node slot advance publication sequence offset static assert";
        needle = "offsetof(crucible_shmem_node_slot, advance_publication_sequence) == CRUCIBLE_SHMEM_NODE_SLOT_ADVANCE_PUBLICATION_SEQUENCE_OFFSET";
      }
      {
