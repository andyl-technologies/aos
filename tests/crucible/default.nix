...
in rec {
  ...
  phase3 = {
    ...
    ioSubnodeSuite = import ./phase3-io-subnode-suite.nix {
      inherit pkgs lib;
      taskIds = ["T-IO-11"];
    };
    ioSubnodeTrait = import ./phase3-io-subnode-suite.nix {
      inherit pkgs lib;
      attrPath = "checks.crucible.phase3.ioSubnodeTrait";
    };
    blockSubnodeOverlay = import ./phase3-io-subnode-suite.nix {
      inherit pkgs lib;
      attrPath = "checks.crucible.phase3.blockSubnodeOverlay";
    };
    blockCompletionModel = import ./phase3-io-subnode-suite.nix {
      inherit pkgs lib;
      attrPath = "checks.crucible.phase3.blockCompletionModel";
    };
    blockSnapshotRestore = import ./phase3-io-subnode-suite.nix {
      inherit pkgs lib;
      attrPath = "checks.crucible.phase3.blockSnapshotRestore";
    };
    ninePSubnodeServer = import ./phase3-io-subnode-suite.nix {
      inherit pkgs lib;
      attrPath = "checks.crucible.phase3.ninePSubnodeServer";
    };
    ninePSessionLifecycle = import ./phase3-io-subnode-suite.nix {
      inherit pkgs lib;
      attrPath = "checks.crucible.phase3.ninePSessionLifecycle";
    };
    ninePWireAbi = import ./phase3-io-subnode-suite.nix {
      inherit pkgs lib;
      attrPath = "checks.crucible.phase3.ninePWireAbi";
    };
    networkLinkSubnode = import ./phase3-io-subnode-suite.nix {
      inherit pkgs lib;
  ...
  phase7 = {
    ...
    qemuRrControlBoundaryDeviceFlight =
      import ./phase7-qemu-rr-control-boundary-device-flight.nix {
        inherit pkgs lib;
    ...
    gates = rec {
      ...
      perfBench = greenBeforeAdvance {
        ...
        gate = import ./phase7-perf-bench.nix {
          ...
          translationPrefetchNeutrality = phase7.translationPrefetchNeutrality;
          dependencies = [phase2.qemuCheckpointDeltaFlight phase6.gates.replayOracle.rawGate phase6.basicBlockCoverage.rawGate phase7.deviceHostWorkOverlap phase7.fingerprintDigestOffload phase7.qemuHostParallel phase7.segmentParallelReplay phase7.translationPrefetchNeutrality];
        };
        dependencies = [phase2.qemuCheckpointDeltaFlight phase6.gates.replayOracle phase6.basicBlockCoverage phase7.deviceHostWorkOverlap phase7.fingerprintDigestOffload phase7.qemuHostParallel phase7.segmentParallelReplay phase7.translationPrefetchNeutrality];
      };
  ...
  phase9 = {
    gates = rec {
      ...
      campaignOperationalContinuity = import ./phase9-campaign-operational-continuity.nix {
        ...
        campaignContinuityV2 = phase5.gates.campaignContinuityV2.rawGate;
