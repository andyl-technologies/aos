    ...
    phases = [
      {
        ...
        script = ''
          ...
          require_line "$S11_RESULT" "horizon_icount=3300000000"
          ...
          require_line "$S13_RESULT" "PASS_WITH_VALIDATED_FALLBACK"
          ...
          require_line "$S13_RESULT" "race_yield_tested=false"
          require_line "$S13_RESULT" "d25_status=open_until_preemption_explorer_enabled"
          require_line "$S13_RESULT" "fallback_adopted=s11_validated_modeled_throughput_default_only_quantum_until_preemption_explorer"
          ...
          require_fixed "$risk_doc" "**RISK-27** is resolved by \`T-RISK-19\` with the S11-validated default-only"
          ...
          require_fixed "$risk_doc" "\`fallback_adopted=s11_validated_modeled_throughput_default_only_quantum_until_preemption_explorer\`"
          ...
          require_fixed "$decision_doc" "s11_validated_modeled_throughput_default_only_quantum_until_preemption_explorer"
