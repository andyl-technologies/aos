  ...
  phases = [
    {
      ...
      script = ''
        ...
        [ "$checked_count" -eq 15 ] || fail "expected 15 checked risk tasks, found $checked_count"
        ...
        require_fixed "$risk_doc" "\`deadline_api_available=false\`"
        ...
        mkdir -p "$out"
        {
          ...
          echo checked_risk_tasks=15
          echo retired_decision_entries=15
