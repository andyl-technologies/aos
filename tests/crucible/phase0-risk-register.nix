  ...
  phases = [
    {
      ...
      script = ''
        ...
        [ "$checked_count" -eq 10 ] || fail "expected 10 checked risk tasks, found $checked_count"
        ...
        mkdir -p "$out"
        {
          ...
          echo checked_risk_tasks=10
          echo retired_decision_entries=10
          echo phase0_foundational_blockers_open=2
