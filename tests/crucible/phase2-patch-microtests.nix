  ...
  perPatchMicrotests = [
    ...
    }
    {
      ...
      check = certifyExactPatch {
        ...
        liveEvidence = ''
          grep -Fxq 'template_coordinator_schema_version=20' "$live_result"
    ...
    }
    {
      ...
      check = certifyExactPatch {
        ...
        liveEvidence = ''
          grep -Fxq 'patch=0144-crucible-bind-hot-fork-worker-dispositions.patch' "$live_result"
          grep -Fxq 'template_coordinator_schema_version=20' "$live_result"
          grep -Fxq 'template_resource_stage_schema_version=10' "$live_result"
    ...
    }
    {
      ...
      check = certifyExactPatch {
        ...
        liveEvidence = ''
          ...
          grep -Fxq 'template_coordinator_schema_version=20' "$live_result"
          grep -Fxq 'template_resource_stage_schema_version=10' "$live_result"
          grep -Fxq 'child_qmp_schema_version=4' "$live_result"
