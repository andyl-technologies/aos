  ...
  perPatchMicrotests = [
    ...
    }
    {
      ...
      check = certifyExactPatch {
        ...
        liveEvidence = ''
          grep -Fxq 'template_coordinator_schema_version=11' "$live_result"
    ...
    }
    {
      ...
      check = certifyExactPatch {
        ...
        liveEvidence = ''
          grep -Fxq 'patch=0143-crucible-bind-hot-fork-resource-generations.patch' "$live_result"
          grep -Fxq 'plugin_barrier_schema_version=5' "$live_result"
          grep -Fxq 'plugin_barrier_unregistered_shape=true' "$live_result"
          grep -Fxq 'plugin_ring_proof_acknowledged=false' "$live_result"
          grep -Fxq 'template_coordinator_schema_version=11' "$live_result"
    ...
    }
    {
      ...
      check = certifyExactPatch {
        ...
        liveEvidence = ''
          grep -Fxq 'patch=0143-crucible-bind-hot-fork-resource-generations.patch' "$live_result"
          grep -Fxq 'plugin_endpoint_stage_schema_version=2' "$live_result"
    ...
    }
    {
      ...
      check = certifyExactPatch {
        ...
        liveEvidence = ''
          grep -Fxq 'patch=0143-crucible-bind-hot-fork-resource-generations.patch' "$live_result"
          grep -Fxq 'template_coordinator_schema_version=11' "$live_result"
          grep -Fxq 'template_resource_stage_schema_version=1' "$live_result"
