# stdenv/toolchain/tar135.nix — GNU tar 1.35
#
# Production-quality GNU tar built with the final toolchain (GCC 14.3 +
# glibc 2.39 + binutils 2.41). Provides the standard archiving utility.
#
{
  gcc143,
  glibc239,
  ...
  tar-src = fetchSrc {
    ...
    hash = "sha256-FNVeMOBNJcgaJ1MFpCASOBFPSqALFEZbhKGWnRLpcmo=";
  };
...
in
  ...
  // {
    meta = {
      description = "GNU tar archiving utility, version 1.35";
