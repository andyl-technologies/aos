# stdenv/toolchain/sed49.nix — GNU sed 4.9
#
# Production-quality GNU sed built with the final toolchain (GCC 14.3 +
# glibc 2.39 + binutils 2.41). Provides the standard stream editor.
#
{
  gcc143,
  glibc239,
...
in
  ...
  // {
    meta = {
      description = "GNU stream editor, version 4.9";
