# stdenv/toolchains/gcc4_8_cross/sed.nix — Phase 7
#
# Native target-arch GNU sed 4.2.2, cross-compiled from x86_64.
#
{
  prev,
  crossGccStage2,
...
let
  ...
  src = fetchTarball {
    ...
    hash = "1mn6dlmgd1l94qfs39l2h9h5h2mw7v6mcflgk1afypcaxxk4397d";
  };
in
builtins.derivation {
  name = "sed-4.2.2";
  ...
  args = [
    ...
    ''
      ...
      echo "GNU sed 4.2.2 (${hostPlatform.config}) installed to $out"
    ''
  ];
}
