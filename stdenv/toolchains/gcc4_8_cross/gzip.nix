# stdenv/toolchains/gcc4_8_cross/gzip.nix — Phase 7
#
# Native target-arch GNU gzip 1.5, cross-compiled from x86_64.
#
{
  prev,
  crossGccStage2,
...
let
  ...
  src = fetchTarball {
    ...
    hash = "0r41b8dgrda1v305grzs8clg515gnnxc86jg8qx5xn206mjckh84";
  };
in
builtins.derivation {
  name = "gzip-1.5";
  ...
  args = [
    ...
    ''
      ...
      echo "GNU gzip 1.5 (${hostPlatform.config}) installed to $out"
    ''
  ];
}
