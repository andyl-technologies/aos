# stdenv/toolchains/gcc4_8_cross/gawk.nix — Phase 7
#
# Native target-arch GNU awk 4.0.2, cross-compiled from x86_64.
#
{
  prev,
  crossGccStage2,
...
let
  ...
  src = fetchTarball {
    ...
    hash = "19jnai55cpxajnaxkw9iwxxsc8smczh27jwi7hslq5bnmx2nlvy2";
  };
in
builtins.derivation {
  name = "gawk-4.0.2";
  ...
  args = [
    ...
    ''
      ...
      echo "GNU awk 4.0.2 (${hostPlatform.config}) installed to $out"
    ''
  ];
}
