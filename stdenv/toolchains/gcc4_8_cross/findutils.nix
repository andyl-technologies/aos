# stdenv/toolchains/gcc4_8_cross/findutils.nix — Phase 7
#
# Native target-arch GNU findutils 4.6.0, cross-compiled from x86_64.
#
{
  prev,
  crossGccStage2,
  ...
  builtins.derivation {
    ...
    args = [
      ...
      ''
        ...
        echo "GNU findutils 4.6.0 (${hostPlatform.config}) installed to $out"
      ''
    ];
  }
