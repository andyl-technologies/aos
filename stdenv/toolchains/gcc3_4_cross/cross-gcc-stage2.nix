# stdenv/toolchains/gcc3_4_cross/cross-gcc-stage2.nix — Phase 5
#
# Cross GCC 3.4.6 stage 2: runs on i686, targets x86_64, with glibc.
# Full C cross-compiler with libc support for building POSIX tools.
#
{
  prev,
  crossBinutils,
...
let
  ...
  src = fetchTarball {
    ...
    hash = "09v2s3ij1pxng9k3z4w98058lvd2m98jywiv5xfiwzxvnp1n5jwq";
  };
in
builtins.derivation {
  name = "cross-gcc-stage2-3.4.6";
  ...
  args = [
    ...
    ''
      ...
      # GCC looks for crt1.o/crti.o/crtn.o in its own lib dir and $prefix/$target/lib/.
      GCCLIB="$out/lib/gcc/${hostPlatform.config}/3.4.6"
