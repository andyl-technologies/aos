# stdenv/toolchains/gcc3_4_cross/tar.nix — Phase 7
#
# Native x86_64 GNU tar 1.14, cross-compiled from i686.
#
{
  prev,
  crossGccStage2,
...
builtins.derivation {
  ...
  args = [
    ...
    ''
      ...
      echo "GNU tar 1.14 (${hostPlatform.config}) installed to $out"
    ''
  ];
}
