  ...
  builtins.derivation {
    ...
    args = [
      ...
      ''
        ...
        # archiving PIC objects. Force libc.a first so all equivalent static
        # stamps exist before generating librtld.mk, then resolve the linker
        # map in the bootstrap shell. The patch names the two verified
