# stdenv/toolchains/gcc4_8/gawk.nix — GNU awk 4.0.2 (RHEL 7)
#
...
builtins.derivation {
  ...
  args = [
    ...
    ''
      ...
      echo "GNU awk 4.0.2 installed to $out"
    ''
  ];
}
// {
  meta = {
    description = "GNU awk pattern scanning and processing language, version 4.0.2";
