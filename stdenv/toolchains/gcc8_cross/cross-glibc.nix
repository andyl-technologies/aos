...
let
  ...
  linkSysdep =
    if hostPlatform.constraints.cpu == "x86_64" then "x86_64"
    else if hostPlatform.constraints.cpu == "i686" then "i386"
    else if hostPlatform.constraints.cpu == "aarch64" then "aarch64"
    else if hostPlatform.constraints.cpu == "riscv64" then "riscv"
