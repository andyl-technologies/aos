# stdenv/toolchains/gcc8_cross/sed.nix — Phase 7
#
# Native target-arch GNU sed 4.5, cross-compiled from x86_64.
#
{
  prev,
  crossGccStage2,
  ...
  builtins.derivation {
    ...
    args = [
      ...
      ''
        ...
        echo "GNU sed 4.5 (${hostPlatform.config}) installed to $out"
      ''
    ];
  }
