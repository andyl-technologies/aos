# stdenv/toolchains/gcc8_cross/gawk.nix — Phase 7
#
# Native target-arch GNU awk 4.2.1, cross-compiled from x86_64.
#
{
  prev,
  crossGccStage2,
...
builtins.derivation {
  ...
  args = [
    ...
    ''
      ...
      echo "GNU awk 4.2.1 (${hostPlatform.config}) installed to $out"
    ''
  ];
}
