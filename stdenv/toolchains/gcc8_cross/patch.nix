# stdenv/toolchains/gcc8_cross/patch.nix — Phase 7
#
# Native target-arch GNU patch 2.7.6, cross-compiled from x86_64.
#
{
  prev,
  crossGccStage2,
  ...
  builtins.derivation {
    ...
    args = [
      ...
      ''
        ...
        echo "GNU patch 2.7.6 (${hostPlatform.config}) installed to $out"
      ''
    ];
  }
