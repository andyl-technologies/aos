# stdenv/toolchains/gcc8_cross/cross-gcc-stage2.nix — Phase 5
#
# Cross GCC 8.5.0 stage 2: runs on x86_64, targets target arch, with glibc.
    ...
    args = [
      ...
      ''
        ...
        "$SRC/configure" \
          ...
          --with-gxx-include-dir="$out/include/c++/8.5.0" \
        ...
        test -s "$out/include/c++/8.5.0/cstring"
