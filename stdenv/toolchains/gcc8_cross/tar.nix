# stdenv/toolchains/gcc8_cross/tar.nix — Phase 7
#
# Native target-arch GNU tar 1.30, cross-compiled from x86_64.
#
{
  prev,
  crossGccStage2,
...
builtins.derivation {
  ...
  args = [
    ...
    ''
      ...
      echo "GNU tar 1.30 (${hostPlatform.config}) installed to $out"
    ''
  ];
}
