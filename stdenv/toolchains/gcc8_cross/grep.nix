# stdenv/toolchains/gcc8_cross/grep.nix — Phase 7
#
# Native target-arch GNU grep 3.1, cross-compiled from x86_64.
#
{
  prev,
  crossGccStage2,
  ...
  builtins.derivation {
    ...
    args = [
      ...
      ''
        ...
        echo "GNU grep 3.1 (${hostPlatform.config}) installed to $out"
      ''
    ];
  }
