# stdenv/toolchains/gcc8_cross/default.nix — x86_64→target cross tier (GCC 8)
#
# Takes the gcc8 toolchain (x86_64) as `prev` and cross-compiles a complete
# target-arch toolchain using GCC 8.5.0 + binutils 2.30 + glibc 2.28.
#
# Used for architectures whose backend was added after GCC 4.8 (e.g. RISC-V).
