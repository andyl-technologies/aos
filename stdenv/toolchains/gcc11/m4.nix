# stdenv/toolchains/gcc11/m4.nix — GNU m4 1.4.19 (RHEL 9)
#
...
builtins.derivation {
  ...
  args = [
    ...
    ''
      ...
      cd "$TMPDIR"
      mkdir m4-1.4.19 && (cd ${src} && ${prev.tar}/bin/tar cf - .) | (cd m4-1.4.19 && ${prev.tar}/bin/tar xf -)
      cd m4-1.4.19
      chmod -R u+w .
      ...
      echo "GNU m4 1.4.19 installed to $out"
    ''
  ];
}
// {
  meta = {
    description = "GNU m4 macro processor, version 1.4.19";
