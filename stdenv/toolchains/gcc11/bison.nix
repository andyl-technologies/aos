# stdenv/toolchains/gcc11/bison.nix — GNU Bison 3.8.2 (RHEL 9)
#
...
builtins.derivation {
  ...
  args = [
    ...
    ''
      ...
      export PATH="${texinfo}/bin:${help2man}/bin:${perl}/bin:${prev.coreutils}/bin:${gcc}/bin:${binutils}/bin:${prev.gnumake}/bin:${prev.sed}/bin:${prev.grep}/bin:${prev.gawk}/bin:${prev.findutils}/bin:${prev.tar}/bin:${prev.gzip}/bin:${prev.diffutils}/bin:${prev.bash}/bin:${prev.patch}/bin:${m4}/bin:${flex}/bin"
      export CONFIG_SHELL="${prev.bash}/bin/bash"

      # Bison needs to find m4 at runtime
      export M4="${m4}/bin/m4"
