# stdenv/toolchains/gcc8/m4.nix — GNU m4 1.4.19 (for glibc 2.28+ compat)
#
# Built with THIS tier's GCC 8.5.0 + binutils 2.30 + glibc 2.28.
# m4 1.4.18 gnulib is incompatible with glibc 2.28 (removed libio.h);
# 1.4.19 has updated gnulib that handles this.
#
{
  prev,
  gcc,
...
builtins.derivation {
  ...
  args = [
    ...
    ''
      ...
      echo "GNU m4 1.4.18 installed to $out"
    ''
  ];
}
// {
  meta = {
    description = "GNU macro processor, version 1.4.19";
