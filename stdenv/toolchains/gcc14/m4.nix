# stdenv/toolchains/gcc14/m4.nix — GNU m4 1.4.19 (RHEL 10)
#
# GNU m4 macro processor built with THIS tier's GCC 14.3.0 + binutils 2.41 + glibc 2.39.
#
{
  prev,
  gcc,
...
in
  ...
  // {
    meta = {
      description = "GNU m4 macro processor 1.4.19";
