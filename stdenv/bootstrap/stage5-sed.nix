# stdenv/bootstrap/stage5-sed.nix — GNU sed 4.0.9 from GCC 2.95.3 (glibc)
#
# Compiled with self-hosted GCC 2.95.3 linked against glibc 2.2.5.
# Uses configure/make.
#
# sed 4.0.9 uses autoconf 2.5x+, so it needs the same fixSubsScript/
...
in
  ...
  // {
    meta = {
      description = "GNU sed 4.0.9 — built from GCC 2.95.3 with glibc for bootstrap";
