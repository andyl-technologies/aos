...
use crucible_shmem::{
    ...
    FaultCapabilityRowV1, FaultCapabilityScope, FaultClockCapabilityManifestV2,
    FaultClockCapabilityRowV2, FaultClockEvidenceV2, FaultClockObservationV2, FaultCommandHeaderV1,
