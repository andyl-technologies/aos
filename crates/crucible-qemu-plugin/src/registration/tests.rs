...
fn registration_order_parse_step_uses_fail_closed_args() {
    ...
    let args = match sequence.parse_arguments("simfd=3,slot=1,fault_node_hash=1111111111111111111111111111111111111111111111111111111111111111,process_generation=1,network_tx_next_seq=0") {
        Ok(args) => args,
    ...
    let error = failed
        .parse_arguments("slot=0,fault_node_hash=1111111111111111111111111111111111111111111111111111111111111111,process_generation=1,network_tx_next_seq=0")
        .err()
...
fn registration_order_performs_control_handshake_after_parse() {
    let mut sequence = PluginRegistrationSequence::new();
    let args = sequence
        .parse_arguments("simfd=3,slot=1,fault_node_hash=1111111111111111111111111111111111111111111111111111111111111111,process_generation=1,network_tx_next_seq=0")
...
fn registration_order_rejects_control_handshake_before_parse_without_io() {
    ...
    let args = registration_args(
        "simfd=3,slot=0,fault_node_hash=1111111111111111111111111111111111111111111111111111111111111111,process_generation=1,network_tx_next_seq=0",
    );
...
fn registration_order_fails_loud_when_handshake_slot_disagrees_with_launch_args() {
    let mut sequence = PluginRegistrationSequence::new();
    let args = sequence
        .parse_arguments("simfd=3,slot=0,fault_node_hash=1111111111111111111111111111111111111111111111111111111111111111,process_generation=1,network_tx_next_seq=0")
        .unwrap_or_else(|error| panic!("valid arguments should parse: {error}"));
...
fn registration_coverage_on_requires_basic_block_callback_capability() {
    ...
    record_steps_through_wake_fd(&mut sequence);
    let args = registration_args(
        "simfd=3,slot=0,fault_node_hash=1111111111111111111111111111111111111111111111111111111111111111,process_generation=1,network_tx_next_seq=0,coverage=on",
    );
