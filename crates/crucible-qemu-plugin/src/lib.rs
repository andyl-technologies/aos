...
pub use whitebox_doorbell::{
    ...
    QEMU_PLUGIN_REGISTER_DOORBELL_TRAP_SYMBOL, SELECTABLE_CATALOG_HARD_MAX_DECLARATIONS,
    ...
    SelectableCatalogLimits, SelectableCatalogPhase, SelectableDoorbellError,
    ...
    SelectableRegistrationService, SelectableReplyService, WHITEBOX_APP_RANDOM_MAX_WIDTH_BYTES,
