...
pub use abi::{
    ...
    QEMU_PLUGIN_REQUEST_VMSTOP_SYMBOL, QEMU_PLUGIN_VERSION_SYMBOL, QemuBlkEventCommitCbFn,
    ...
    QemuPluginExecutionModel, QemuPluginId, QemuPluginInfo, QemuRegisterBlkCbFn,
    QemuRegisterBlkEventCbFn, QemuRegisterBlkWaitCbFn, QemuRegisterNinePCbFn,
    ...
    resolve_qemu_request_vmstop_symbol, resolve_qemu_rr_cursor_symbol, validate_install_boundary,
};
pub use args::{
