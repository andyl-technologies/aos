...
pub use abi::{
    ...
    QEMU_PLUGIN_REGISTER_BLK_WAIT_CB_SYMBOL, QEMU_PLUGIN_REGISTER_ENTRYPOINT_SYMBOL,
    ...
    QEMU_PLUGIN_VERSION_SYMBOL, QemuBlkEventCommitCbFn, QemuBlkEventPollCbFn, QemuBlkPollCbFn,
    QemuBlkSubmitCbFn, QemuBlkTransportRestoreCbFn, QemuBlkTransportSaveCbFn, QemuBlkWaitCbFn,
    ...
    QemuPluginInfo, QemuRegisterBlkCbFn, QemuRegisterBlkEventCbFn, QemuRegisterBlkWaitCbFn,
    QemuRegisterNinePCbFn, QemuRegisterSimShmemDispatchCbFn, QemuRegisterTcgExecCbFn,
    QemuRegisterVcpuIdleResumeCbFn, QemuRegisterVcpuInitCbFn, QemuRegisterWakeFdFn,
    QemuRequestShutdownFn, QemuSimShmemMaxAdvanceIcountCbFn, QemuSimShmemPublishIcountCbFn,
...
pub use args::{
    ...
    PLUGIN_ARG_COVERAGE, PLUGIN_ARG_FAULT_NODE_HASH, PLUGIN_ARG_FINGERPRINT, PLUGIN_ARG_SHMEMFD,
    PLUGIN_ARG_SIMFD, PLUGIN_ARG_SLOT, PLUGIN_ARG_WAKEFD, PLUGIN_ARG_WHITEBOX,
    PLUGIN_ARG_WHITEBOX_SETUP, PluginAppRandomConfig, PluginArgs, PluginArgsParseError,
    PluginInheritedFds, PluginStateDumpConfig, PluginSwitch,
...
pub use fault_command::{
    ...
    QEMU_PLUGIN_CRUCIBLE_FAULT_POLL_SYMBOL, QEMU_PLUGIN_CRUCIBLE_FAULT_SUBMIT_SYMBOL,
};
