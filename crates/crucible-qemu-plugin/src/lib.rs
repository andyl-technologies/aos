...
pub use whitebox_doorbell::{
    ...
    QEMU_PLUGIN_REGISTER_DOORBELL_TRAP_SYMBOL, SelectableCallbackCoordinate,
    SelectableDoorbellError, SelectableDoorbellOutcome, SelectableDoorbellService,
    SelectableDoorbellServiceError, SelectableRegistrationService, SelectableReplyService,
