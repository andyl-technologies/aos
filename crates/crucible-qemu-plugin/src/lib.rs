...
pub use abi::{
    ...
    QemuSimShmemLogicalCeilingCbFn, QemuSimShmemMaxAdvanceIcountCbFn,
    QemuSimShmemPublishIcountCbFn, QemuTcgThreading, QemuVcpuIdleResumeCbFn, qemu_plugin_install,
    qemu_plugin_version, resolve_qemu_advance_time_ticks_symbol,
    resolve_qemu_arm_virtual_timer_witness_symbol, resolve_qemu_clock_deadline_symbol,
    resolve_qemu_force_vcpu_exit_symbol, resolve_qemu_icount_raw_symbol,
    resolve_qemu_inject_preemption_symbol, resolve_qemu_query_virtual_timer_witness_symbol,
    resolve_qemu_read_vcpu_regs_symbol, resolve_qemu_register_9p_cb_symbol,
    resolve_qemu_register_accelerator_cb_symbol, resolve_qemu_register_blk_cb_symbol,
    resolve_qemu_register_blk_event_cb_symbol, resolve_qemu_register_blk_wait_cb_symbol,
    resolve_qemu_register_control_boundary_cb_symbol,
