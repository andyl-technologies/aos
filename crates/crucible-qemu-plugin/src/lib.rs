...
pub use whitebox_doorbell::{
    ...
    GOLDEN_WHITEBOX_DOORBELL_FRAME_VECTORS, GuestMemoryAddressSpace, GuestMemoryRange,
    GuestMemoryReadError, GuestMemoryReader, PluginWhiteboxDoorbell,
    QEMU_PLUGIN_DOORBELL_MEM_CB_SYMBOL, QEMU_PLUGIN_DOORBELL_TRANSLATION_SYMBOL,
    QEMU_PLUGIN_GET_HWADDR_SYMBOL, QEMU_PLUGIN_GUEST_MEMORY_READ_SYMBOL,
    QEMU_PLUGIN_GUEST_MEMORY_WRITE_SYMBOL, QEMU_PLUGIN_HWADDR_PHYS_ADDR_SYMBOL,
    QEMU_PLUGIN_IO_ADDRESS_QUERY_SYMBOL, QEMU_PLUGIN_READ_REGISTER_SYMBOL,
    ...
    WHITEBOX_DOORBELL_KIND_RANDOM_REQUEST, WHITEBOX_DOORBELL_PROTOCOL_VERSION,
    WHITEBOX_DOORBELL_X86_64_ABI, WHITEBOX_DOORBELL_X86_64_OUT_DX_EAX_BYTES,
    WHITEBOX_DOORBELL_X86_64_RESERVED_PORT, WhiteboxDoorbellAbi, WhiteboxDoorbellArchitecture,
    WhiteboxDoorbellCapabilities, WhiteboxDoorbellCollision, WhiteboxDoorbellError,
    WhiteboxDoorbellFrame, WhiteboxDoorbellFrameDecodeError, WhiteboxDoorbellFrameEncodeError,
    WhiteboxDoorbellFrameGoldenVector, WhiteboxDoorbellInstruction, WhiteboxDoorbellPayloadSource,
    WhiteboxDoorbellRegistrationPlan, WhiteboxDoorbellSetupOutcome, WhiteboxDoorbellSetupResources,
    WhiteboxDoorbellSetupValidation, WhiteboxDoorbellTrap, WhiteboxDoorbellTrapAbi,
