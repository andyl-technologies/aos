...
pub use abi::{
    ...
    QEMU_PLUGIN_REGISTER_ENTRYPOINT_SYMBOL,
    ...
    QemuRegisterBlkCbFn, QemuRegisterBlkWaitCbFn, QemuRegisterNinePCbFn,
    QemuRegisterSimShmemDispatchCbFn, QemuRegisterTcgExecCbFn,
    QemuRegisterVcpuIdleResumeCbFn, QemuRegisterVcpuInitCbFn,
    QemuRegisterWakeFdFn, QemuRequestShutdownFn, QemuSimShmemMaxAdvanceIcountCbFn,
    QemuSimShmemPublishIcountCbFn, QemuTcgExecCbFn, QemuTcgThreading, QemuVcpuIdleResumeCbFn,
    QemuVcpuSimpleCbFn, RegisteredDeviceCallbacks, execution_model_from_qemu_info,
    install_inert_scaffold, install_inert_scaffold_from_qemu_info,
    ...
    resolve_qemu_register_blk_wait_cb_symbol,
