...
mod tests {
    ...
    fn plugin_handshake_sends_compiled_versions_and_accepts_matching_slot() {
        ...
        let args = plugin_args(
            "simfd=3,slot=2,fault_node_hash=1111111111111111111111111111111111111111111111111111111111111111,process_generation=1,network_tx_next_seq=0",
        );
    ...
    fn plugin_handshake_rejects_launch_slot_outside_node_count() {
        let args = plugin_args(
            "simfd=3,slot=4,fault_node_hash=1111111111111111111111111111111111111111111111111111111111111111,process_generation=1,network_tx_next_seq=0",
        );
    ...
    fn plugin_handshake_rejects_launch_slot_disagreement() {
        let args = plugin_args(
            "simfd=3,slot=1,fault_node_hash=1111111111111111111111111111111111111111111111111111111111111111,process_generation=1,network_tx_next_seq=0",
        );
        let negotiated = NegotiatedHandshake {
            proto_version: CONTROL_PROTOCOL_VERSION,
            abi_version: ABI_VERSION,
