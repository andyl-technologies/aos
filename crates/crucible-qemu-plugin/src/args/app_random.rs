...
mod tests {
    ...
    fn complete_group_parses() {
        let args = PluginArgs::parse(
            "simfd=4,slot=1,fault_node_hash=1111111111111111111111111111111111111111111111111111111111111111,process_generation=1,whitebox=on,whitebox_setup=x86-port-00e7-unclaimed-v1,app_random_seed=1048598,app_random_cap=2,app_random_node=node-a",
        )
    ...
    fn continuation_positions_parse() {
        let args = PluginArgs::parse(
            "simfd=4,slot=1,fault_node_hash=1111111111111111111111111111111111111111111111111111111111111111,process_generation=1,whitebox=on,whitebox_setup=x86-port-00e7-unclaimed-v1,app_random_seed=11,app_random_cap=8,app_random_node=node-a,app_random_draw_offset=3,app_random_positions=616c706861:2;62657461:1",
        )
    ...
    fn complete_branch_group_parses() {
        let args = PluginArgs::parse(
            "simfd=4,slot=1,fault_node_hash=1111111111111111111111111111111111111111111111111111111111111111,process_generation=1,whitebox=on,whitebox_setup=x86-port-00e7-unclaimed-v1,app_random_seed=1048598,app_random_cap=9,app_random_node=node-a,app_random_branch_seed=77,app_random_branch_after=2",
        )
    ...
    fn partial_or_disabled_group_is_rejected() {
        assert_eq!(
            PluginArgs::parse(
                "simfd=3,slot=0,fault_node_hash=1111111111111111111111111111111111111111111111111111111111111111,process_generation=1,whitebox=on,whitebox_setup=x86-port-00e7-unclaimed-v1,app_random_seed=7"
            ),
        ...
        assert_eq!(
            PluginArgs::parse(
                "simfd=3,slot=0,fault_node_hash=1111111111111111111111111111111111111111111111111111111111111111,process_generation=1,app_random_seed=7,app_random_cap=1,app_random_node=node-a"
            ),
            Err(PluginArgsParseError::AppRandom(
        ...
        assert_eq!(
            PluginArgs::parse(
                "simfd=3,slot=0,fault_node_hash=1111111111111111111111111111111111111111111111111111111111111111,process_generation=1,whitebox=on,whitebox_setup=x86-port-00e7-unclaimed-v1,app_random_seed=7,app_random_cap=1,app_random_node=node-a,app_random_branch_seed=9"
            ),
            Err(PluginArgsParseError::AppRandom(
        ...
        assert_eq!(
            PluginArgs::parse(
                "simfd=3,slot=0,fault_node_hash=1111111111111111111111111111111111111111111111111111111111111111,process_generation=1,whitebox=on,whitebox_setup=x86-port-00e7-unclaimed-v1,app_random_draw_offset=1"
            ),
            Err(PluginArgsParseError::AppRandom(
                AppRandomArgsParseError::Incomplete
            ))
        ...
        assert!(matches!(
            PluginArgs::parse(
                "simfd=3,slot=0,fault_node_hash=1111111111111111111111111111111111111111111111111111111111111111,process_generation=1,whitebox=on,whitebox_setup=x86-port-00e7-unclaimed-v1,app_random_seed=7,app_random_cap=4,app_random_node=node-a,app_random_draw_offset=2,app_random_positions=616c706861:1"
            ),
            Err(PluginArgsParseError::AppRandom(
        ...
        assert!(matches!(
            PluginArgs::parse(
                "simfd=3,slot=0,fault_node_hash=1111111111111111111111111111111111111111111111111111111111111111,process_generation=1,whitebox=on,whitebox_setup=x86-port-00e7-unclaimed-v1,app_random_seed=7,app_random_cap=4,app_random_node=node-a,app_random_branch_seed=9,app_random_branch_after=1,app_random_draw_offset=2,app_random_positions=616c706861:2"
            ),
            Err(PluginArgsParseError::AppRandom(
