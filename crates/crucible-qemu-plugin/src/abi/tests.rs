...
fn abi_install_parses_qemu_plugin_argv_before_runtime_activation() {
    let (_strings, mut split_argv) = plugin_argv(&[
        "simfd=3",
        "slot=2,fault_node_hash=1111111111111111111111111111111111111111111111111111111111111111,process_generation=1,network_tx_next_seq=0",
        "shmemfd=4",
        "wakefd=5",
        "whitebox=off",
        "coverage=on",
    ...
    let (_strings, mut single_argv) = plugin_argv(&[
        "simfd=3,slot=0,fault_node_hash=1111111111111111111111111111111111111111111111111111111111111111,process_generation=1,network_tx_next_seq=0,shmemfd=4,wakefd=5,whitebox=on,whitebox_setup=x86-port-00e7-unclaimed-v1,coverage=off",
    ]);
