...
/// A failure to parse or validate an RFC-0018 OCI contract value.
...
pub enum Error {
    ...
    /// A repository name was not already in canonical RFC-0018 form.
    ...
    /// A tag was not already in canonical RFC-0018 form.
