...
//!
//! RFC-0019 deliberately distinguishes uploaded bytes from parsed records.
...
//! - [`limits`] freezes the RFC-0019 structural admission limits.
...
pub use release::{
    ...
    CONTAINER_SIGNATURE_INPUT_SCHEMA_V1, ContainerDsseEnvelope, ContainerDsseSignature,
    ContainerEvidenceMappingQualification, ContainerEvidenceMappingUnknownPath,
    ContainerEvidencePackageCandidate, ContainerEvidencePackageOutput,
    ContainerEvidenceQualification, ContainerEvidenceQualificationCheck,
    ContainerEvidenceSourceIdentity, ContainerEvidenceUnknownPath, ContainerNixProvenance,
    ContainerOciRelease, ContainerRelease, ContainerReleaseEvidence, ContainerReleaseIdentity,
    ContainerSignatureInput, ContainerSignatureInputEvidence, NixDefinitionIdentity,
    NixOutputIdentity, definition_attribute_matches_image,
};
