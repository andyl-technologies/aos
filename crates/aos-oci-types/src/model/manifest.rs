...
pub struct ImageManifest {
    ...
    /// Required artifact type for an RFC-0017 artifact manifest.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    ...
    /// Optional referred manifest; required for RFC-0017 artifacts.
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
pub struct ImageIndex {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub media_type: Option<MediaType>,
    /// Reserved artifact type, not admitted on indexes in RFC-0017 v1.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub artifact_type: Option<MediaType>,
...
impl ImageIndex {
    ...
    pub fn validate(&self) -> Result<()> {
        ...
        if self.artifact_type.is_some() {
            return Err(Error::invalid(
                "index artifactType",
                "artifact indexes are not admitted in RFC-0017 v1",
            ));
        }
