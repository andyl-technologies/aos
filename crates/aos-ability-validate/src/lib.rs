...
pub use package_projection::{
    InterfaceDocumentProjection, PACKAGE_OUTPUT_SELECTOR_MARKER, PACKAGE_PROJECTION_SCHEMA,
    PackageAbilityProjection, PackageOutputSelector, ResolvedPackageOutput,
