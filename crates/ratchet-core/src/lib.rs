...
pub use ir::{
    ...
    IrDependencyFootprint, IrDialectOp, IrError, IrErrorKind, IrFacts, IrFrameCaptureFootprint,
    IrId, IrInlineCacheSiteId, IrKind, IrLowerOptions, IrNode, IrShape, IrShapeId, IrWithChain,
    LambdaAttrKeys, LambdaAttrValueSummary, LambdaCallSummary, LambdaDemand, LambdaFormalSummary,
    PASS_SET_VERSION, PassOutcome, SIMPLIFY_MAX_ITERS, SharedChainReason, SimplifyError,
