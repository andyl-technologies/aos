...
//! [`context`] models caller-supplied protected configuration, while
...
pub use transcript::{
    BrokerSessionTranscriptError, BrokerSessionTranscriptPhaseV1,
    VerifiedBrokerSessionTranscriptV1, verify_broker_session_transcript_v1,
};
