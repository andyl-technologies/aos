//! Page composition, re-exported from [`aos_registry_core::web::browse_pages`].
//!
...
//! [`SessionIndicator`](aos_registry_core::web::console_render::SessionIndicator)
...
use aos_registry_core::stack::StackNode;
...
/// [`aos_registry_core::web::browse_pages::instance_home`], supplying the
...
pub fn instance_home(
    ...
    aos_registry_core::web::browse_pages::instance_home(
        rows,
        query,
        page_number,
        started,
...
///
/// Native-hub shim over
/// [`aos_registry_core::web::browse_pages::registry_home`].
...
///
/// Native-hub shim over
/// [`aos_registry_core::web::browse_pages::package_index`].
#[must_use]
...
///
/// Native-hub shim over
/// [`aos_registry_core::web::browse_pages::package_page`].
#[must_use]
pub fn package_page(
    registry: &RegistryRecord,
    status: Option<&IndexStatus>,
...
///
/// Native-hub shim over
/// [`aos_registry_core::web::browse_pages::channel_page`].
#[must_use]
pub fn channel_page(
    registry: &RegistryRecord,
    status: Option<&IndexStatus>,
...
///
/// Native-hub shim over
/// [`aos_registry_core::web::browse_pages::channels_index`].
#[must_use]
...
///
/// Native-hub shim over
/// [`aos_registry_core::web::browse_pages::releases_page`].
#[must_use]
...
///
/// Native-hub shim over [`aos_registry_core::web::browse_pages::health_page`].
#[allow(clippy::too_many_arguments)]
#[must_use]
pub fn health_page(
    registry: &RegistryRecord,
    ...
    aos_registry_core::web::browse_pages::health_page(
        registry,
        status,
        runs,
        stack,
