...
//! into the shared, wasm-clean [`aos_registry_core::web::console_render`] so the
...
//! handler verifies on submit; the [`csrf_field`](aos_registry_core::web::console_render::csrf_field)
