...
//!
//! The canonical indexer was relocated to [`aos_registry_core::indexer`]
//! (RFC-0004 Phase 5) so the native hub's reindex and the Cloudflare Worker's
//! Cron job run the *same* indexing logic over the
//! [`SurfaceFetch`](aos_registry_core::fetch::SurfaceFetch) port. This module
...
//!
//! See [`aos_registry_core::indexer`] for the module overview: the failure
...
pub use aos_registry_core::indexer::*;
