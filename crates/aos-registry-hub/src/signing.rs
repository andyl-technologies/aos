//! Hosted-key signing — re-export of the shared [`aos_registry_core::signing`].
//!
...
//! [`aos_registry_core::signing`] (RFC-0004 Phase 5) so the *same* code signs on
...
//! and a [`Reindexer`](aos_registry_core::reindex::Reindexer) rather than a host
...
pub use aos_registry_core::signing::*;
