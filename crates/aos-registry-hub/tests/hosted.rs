...
use aos_registry_hub::signing;
use aos_registry_hub::surface::object::{hash_object, ObjectKind};
use aos_registry_hub::surface::tag::verify_signed_tag;
use axum::body::Body;
...
fn enrollment_returns_a_valid_trusted_key_line_and_audits() {
    ...
    let derived = aos_registry_hub::surface::sshsig::trusted_key_line(
        "acme-release",
