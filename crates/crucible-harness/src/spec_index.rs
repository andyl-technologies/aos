...
pub const CRATE_SPEC_INDEX: &[CrateSpecIndexEntry] = &[
    ...
    CrateSpecIndexEntry {
        ...
        root: "src/lib.rs",
        spec_files: &["16"],
        supplemental_spec: Some("RFC-0017 file 02"),
        section_6_row: true,
    },
    CrateSpecIndexEntry {
        package: "crucible",
    ...
    CrateSpecIndexEntry {
        ...
        root: "src/lib.rs",
        spec_files: &[],
        supplemental_spec: Some("RFC-0017 files 01, 02, 04a, 06, 09"),
        section_6_row: false,
    },
    CrateSpecIndexEntry {
        ...
        root: "src/lib.rs",
        spec_files: &[],
        supplemental_spec: Some("RFC-0017 files 04a, 06"),
        section_6_row: false,
    },
    CrateSpecIndexEntry {
        ...
        root: "src/lib.rs",
        spec_files: &[],
        supplemental_spec: Some("RFC-0017 file 06"),
        section_6_row: false,
    },
    CrateSpecIndexEntry {
    ...
    CrateSpecIndexEntry {
        ...
        root: "src/lib.rs",
        spec_files: &["20", "21"],
        supplemental_spec: Some("RFC-0017 file 04a"),
        section_6_row: true,
    },
    CrateSpecIndexEntry {
