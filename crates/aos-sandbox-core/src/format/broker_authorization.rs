...
mod tests {
    ...
    const PLAN_HEX: &str = "";
    ...
    fn every_signed_broker_verb_round_trips_canonically() {
        ...
        for verb in verbs {
            ...
            let candidate = BrokerAuthorizationPlan::new(
                audience,
                audience.protocol(),
                if audience == BrokerAudience::Mount {
                    ProtocolVersion::new(2, 0)
                } else {
                    ProtocolVersion::new(1, 0)
                },
