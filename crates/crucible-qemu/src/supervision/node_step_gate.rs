...
impl QemuLiveNodeStepGateConfig {
    ...
    /// Returns this configuration with the default-off translation prefetch experiment enabled.
    #[must_use]
...
fn build_live_node_with_authority(
    ...
    if config.translation_prefetch_experiment {
        command = command.with_translation_prefetch_experiment();
    }
