...
pub use qmp::{
    ...
    QMP_HOT_FORK_AIO_INVENTORY_SCHEMA_VERSION, QMP_HOT_FORK_RCU_INVENTORY_MAX,
    ...
    QMP_QUERY_CPUS_FAST_COMMAND, QMP_QUERY_HOT_FORK_AIO_INVENTORY_COMMAND,
    ...
    QmpError, QmpGreeting, QmpHotForkAioContext, QmpHotForkAioInventory, QmpHotForkProof,
