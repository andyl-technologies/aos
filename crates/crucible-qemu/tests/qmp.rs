...
use crucible_qemu::{
    ...
    QmpCommandKind, QmpError, QmpGreeting, QmpHotForkProof, QmpHotForkTemplateOutcome,
...
fn hot_fork_block_barrier_holds_drains_and_releases_on_main_qmp() -> Result<(), Box<dyn Error>> {
    let stream = scripted_qmp([
        r#"{"QMP":{"version":{},"capabilities":[]}}"#,
        r#"{"return":{}}"#,
        r#"{"return":{"schema-version":2,"generation":2,"owner-thread-id":44,"graph-barrier-generation":1,"graph-mutation-generation":7,"held-graph-mutation-generation":7,"graph-owner-thread-id":44,"held":true,"graph-held":true,"graph-writer-active":false,"graph-waiting-writers":0,"graph-stable":true,"complete":true,"backend-count":3,"rooted-backends":2,"writable-backends":2,"quiesced-rooted-backends":2,"in-flight":1,"quiescent":false}}"#,
        r#"{"return":{"schema-version":2,"generation":2,"owner-thread-id":44,"graph-barrier-generation":1,"graph-mutation-generation":7,"held-graph-mutation-generation":7,"graph-owner-thread-id":44,"held":true,"graph-held":true,"graph-writer-active":false,"graph-waiting-writers":1,"graph-stable":true,"complete":true,"backend-count":3,"rooted-backends":2,"writable-backends":2,"quiesced-rooted-backends":2,"in-flight":0,"quiescent":true}}"#,
        r#"{"return":{"schema-version":2,"generation":3,"owner-thread-id":0,"graph-barrier-generation":2,"graph-mutation-generation":7,"held-graph-mutation-generation":0,"graph-owner-thread-id":0,"held":false,"graph-held":false,"graph-writer-active":false,"graph-waiting-writers":0,"graph-stable":false,"complete":true,"backend-count":3,"rooted-backends":2,"writable-backends":2,"quiesced-rooted-backends":0,"in-flight":0,"quiescent":false}}"#,
    ]);
    let audit = stream.audit_handle();
    let mut client = QmpClient::connect(stream)?;
...
fn hot_fork_block_barrier_rejects_malformed_or_wrong_action_state() -> Result<(), Box<dyn Error>> {
    for response in [
        r#"{"return":{"schema-version":2,"generation":2,"owner-thread-id":44,"graph-barrier-generation":1,"graph-mutation-generation":7,"held-graph-mutation-generation":6,"graph-owner-thread-id":44,"held":true,"graph-held":true,"graph-writer-active":false,"graph-waiting-writers":0,"graph-stable":true,"complete":true,"backend-count":3,"rooted-backends":2,"writable-backends":2,"quiesced-rooted-backends":2,"in-flight":0,"quiescent":true}}"#,
        r#"{"return":{"schema-version":2,"generation":2,"owner-thread-id":44,"graph-barrier-generation":1,"graph-mutation-generation":7,"held-graph-mutation-generation":7,"graph-owner-thread-id":45,"held":true,"graph-held":true,"graph-writer-active":false,"graph-waiting-writers":0,"graph-stable":true,"complete":true,"backend-count":3,"rooted-backends":2,"writable-backends":2,"quiesced-rooted-backends":2,"in-flight":0,"quiescent":true}}"#,
        r#"{"return":{"schema-version":2,"generation":2,"owner-thread-id":44,"graph-barrier-generation":1,"graph-mutation-generation":7,"held-graph-mutation-generation":7,"graph-owner-thread-id":44,"held":true,"graph-held":true,"graph-writer-active":true,"graph-waiting-writers":0,"graph-stable":true,"complete":true,"backend-count":3,"rooted-backends":2,"writable-backends":2,"quiesced-rooted-backends":2,"in-flight":0,"quiescent":true}}"#,
        r#"{"return":{"schema-version":2,"generation":3,"owner-thread-id":0,"graph-barrier-generation":2,"graph-mutation-generation":7,"held-graph-mutation-generation":7,"graph-owner-thread-id":0,"held":false,"graph-held":false,"graph-writer-active":false,"graph-waiting-writers":0,"graph-stable":false,"complete":true,"backend-count":3,"rooted-backends":2,"writable-backends":2,"quiesced-rooted-backends":0,"in-flight":0,"quiescent":false}}"#,
...
-> Result<(), Box<dyn Error>> {
    let stream = scripted_qmp([
        r#"{"QMP":{"version":{},"capabilities":[]}}"#,
        r#"{"return":{}}"#,
        r#"{"return":{"schema-version":6,"generation":4,"outcome":"draining","transaction-active":true,"required-proofs":511,"acknowledged-proofs":7,"missing-proofs":504,"plugin-barrier":{"schema-version":1,"generation":8,"registered":true,"manifest-consistent":true,"held":false,"teardown-closed":false,"in-flight":0,"quiescent":false},"rcu-barrier":{"schema-version":1,"generation":7,"owner-thread-id":0,"held":false,"complete":true,"registered-readers":2,"active-readers":0,"admissions-in-flight":0,"pending-callbacks":0,"drain-active":false,"quiescent":false},"bh-timer-barrier":{"schema-version":2,"generation":7,"owner-thread-id":0,"held":false,"complete":true,"bottom-halves-complete":true,"timers-complete":true,"admissions-in-flight":0,"bottom-half-count":4,"pending-bottom-halves":2,"scheduled-bottom-halves":1,"active-bottom-half-callbacks":0,"pending-timers":3,"active-timer-callbacks":0,"aio-context-count":2,"active-aio-polls":0,"active-aio-dispatches":0,"queued-coroutines":1,"aio-handler-count":3,"active-aio-handler-callbacks":0,"aio-contexts-complete":true,"aio-handlers-complete":true,"quiescent":false},"block-barrier":{"schema-version":2,"generation":4,"owner-thread-id":0,"graph-barrier-generation":6,"graph-mutation-generation":9,"held-graph-mutation-generation":0,"graph-owner-thread-id":0,"held":false,"graph-held":false,"graph-writer-active":false,"graph-waiting-writers":0,"graph-stable":false,"complete":true,"backend-count":3,"rooted-backends":2,"writable-backends":2,"quiesced-rooted-backends":0,"in-flight":0,"quiescent":false},"rollback-complete":false,"ready":false}}"#,
        r#"{"return":{"schema-version":6,"generation":4,"outcome":"draining","transaction-active":true,"required-proofs":511,"acknowledged-proofs":7,"missing-proofs":504,"plugin-barrier":{"schema-version":1,"generation":8,"registered":true,"manifest-consistent":true,"held":false,"teardown-closed":false,"in-flight":0,"quiescent":false},"rcu-barrier":{"schema-version":1,"generation":7,"owner-thread-id":0,"held":false,"complete":true,"registered-readers":2,"active-readers":0,"admissions-in-flight":0,"pending-callbacks":0,"drain-active":false,"quiescent":false},"bh-timer-barrier":{"schema-version":2,"generation":7,"owner-thread-id":0,"held":false,"complete":true,"bottom-halves-complete":true,"timers-complete":true,"admissions-in-flight":0,"bottom-half-count":4,"pending-bottom-halves":2,"scheduled-bottom-halves":1,"active-bottom-half-callbacks":0,"pending-timers":3,"active-timer-callbacks":0,"aio-context-count":2,"active-aio-polls":0,"active-aio-dispatches":0,"queued-coroutines":1,"aio-handler-count":3,"active-aio-handler-callbacks":0,"aio-contexts-complete":true,"aio-handlers-complete":true,"quiescent":false},"block-barrier":{"schema-version":2,"generation":4,"owner-thread-id":44,"graph-barrier-generation":5,"graph-mutation-generation":9,"held-graph-mutation-generation":9,"graph-owner-thread-id":44,"held":true,"graph-held":true,"graph-writer-active":false,"graph-waiting-writers":0,"graph-stable":true,"complete":true,"backend-count":3,"rooted-backends":2,"writable-backends":2,"quiesced-rooted-backends":2,"in-flight":0,"quiescent":true},"rollback-complete":false,"ready":false}}"#,
        r#"{"return":{"schema-version":6,"generation":4,"outcome":"draining","transaction-active":true,"required-proofs":511,"acknowledged-proofs":31,"missing-proofs":480,"plugin-barrier":{"schema-version":1,"generation":8,"registered":true,"manifest-consistent":true,"held":true,"teardown-closed":false,"in-flight":0,"quiescent":true},"rcu-barrier":{"schema-version":1,"generation":6,"owner-thread-id":44,"held":true,"complete":true,"registered-readers":2,"active-readers":0,"admissions-in-flight":0,"pending-callbacks":0,"drain-active":false,"quiescent":true},"bh-timer-barrier":{"schema-version":2,"generation":6,"owner-thread-id":44,"held":true,"complete":true,"bottom-halves-complete":true,"timers-complete":true,"admissions-in-flight":0,"bottom-half-count":4,"pending-bottom-halves":2,"scheduled-bottom-halves":1,"active-bottom-half-callbacks":0,"pending-timers":3,"active-timer-callbacks":0,"aio-context-count":2,"active-aio-polls":0,"active-aio-dispatches":0,"queued-coroutines":1,"aio-handler-count":3,"active-aio-handler-callbacks":0,"aio-contexts-complete":true,"aio-handlers-complete":true,"quiescent":true},"block-barrier":{"schema-version":2,"generation":4,"owner-thread-id":44,"graph-barrier-generation":5,"graph-mutation-generation":9,"held-graph-mutation-generation":9,"graph-owner-thread-id":44,"held":true,"graph-held":true,"graph-writer-active":false,"graph-waiting-writers":0,"graph-stable":true,"complete":true,"backend-count":3,"rooted-backends":2,"writable-backends":2,"quiesced-rooted-backends":2,"in-flight":0,"quiescent":true},"rollback-complete":false,"ready":false}}"#,
        r#"{"return":{"schema-version":6,"generation":4,"outcome":"blocked","transaction-active":false,"required-proofs":511,"acknowledged-proofs":7,"missing-proofs":504,"plugin-barrier":{"schema-version":1,"generation":9,"registered":true,"manifest-consistent":true,"held":false,"teardown-closed":false,"in-flight":0,"quiescent":false},"rcu-barrier":{"schema-version":1,"generation":7,"owner-thread-id":0,"held":false,"complete":true,"registered-readers":2,"active-readers":0,"admissions-in-flight":0,"pending-callbacks":0,"drain-active":false,"quiescent":false},"bh-timer-barrier":{"schema-version":2,"generation":7,"owner-thread-id":0,"held":false,"complete":true,"bottom-halves-complete":true,"timers-complete":true,"admissions-in-flight":0,"bottom-half-count":4,"pending-bottom-halves":2,"scheduled-bottom-halves":1,"active-bottom-half-callbacks":0,"pending-timers":3,"active-timer-callbacks":0,"aio-context-count":2,"active-aio-polls":0,"active-aio-dispatches":0,"queued-coroutines":1,"aio-handler-count":3,"active-aio-handler-callbacks":0,"aio-contexts-complete":true,"aio-handlers-complete":true,"quiescent":false},"block-barrier":{"schema-version":2,"generation":4,"owner-thread-id":0,"graph-barrier-generation":6,"graph-mutation-generation":9,"held-graph-mutation-generation":0,"graph-owner-thread-id":0,"held":false,"graph-held":false,"graph-writer-active":false,"graph-waiting-writers":0,"graph-stable":false,"complete":true,"backend-count":3,"rooted-backends":2,"writable-backends":2,"quiesced-rooted-backends":0,"in-flight":0,"quiescent":false},"rollback-complete":true,"ready":false}}"#,
        r#"{"return":{"schema-version":6,"generation":4,"outcome":"idle","transaction-active":false,"required-proofs":511,"acknowledged-proofs":7,"missing-proofs":504,"plugin-barrier":{"schema-version":1,"generation":9,"registered":true,"manifest-consistent":true,"held":false,"teardown-closed":false,"in-flight":0,"quiescent":false},"rcu-barrier":{"schema-version":1,"generation":7,"owner-thread-id":0,"held":false,"complete":true,"registered-readers":2,"active-readers":0,"admissions-in-flight":0,"pending-callbacks":0,"drain-active":false,"quiescent":false},"bh-timer-barrier":{"schema-version":2,"generation":7,"owner-thread-id":0,"held":false,"complete":true,"bottom-halves-complete":true,"timers-complete":true,"admissions-in-flight":0,"bottom-half-count":4,"pending-bottom-halves":2,"scheduled-bottom-halves":1,"active-bottom-half-callbacks":0,"pending-timers":3,"active-timer-callbacks":0,"aio-context-count":2,"active-aio-polls":0,"active-aio-dispatches":0,"queued-coroutines":1,"aio-handler-count":3,"active-aio-handler-callbacks":0,"aio-contexts-complete":true,"aio-handlers-complete":true,"quiescent":false},"block-barrier":{"schema-version":2,"generation":4,"owner-thread-id":0,"graph-barrier-generation":6,"graph-mutation-generation":9,"held-graph-mutation-generation":0,"graph-owner-thread-id":0,"held":false,"graph-held":false,"graph-writer-active":false,"graph-waiting-writers":0,"graph-stable":false,"complete":true,"backend-count":3,"rooted-backends":2,"writable-backends":2,"quiesced-rooted-backends":0,"in-flight":0,"quiescent":false},"rollback-complete":true,"ready":false}}"#,
    ]);
    let audit = stream.audit_handle();
    let mut client = QmpClient::connect(stream)?;

    let draining = client.prepare_hot_fork_template()?;
...
fn hot_fork_template_abort_is_exact_and_malformed_states_fail_closed() -> Result<(), Box<dyn Error>>
{
    let stream = scripted_qmp([
        r#"{"QMP":{"version":{},"capabilities":[]}}"#,
        r#"{"return":{}}"#,
        r#"{"return":{"schema-version":6,"generation":5,"outcome":"aborted","transaction-active":false,"required-proofs":511,"acknowledged-proofs":7,"missing-proofs":504,"plugin-barrier":{"schema-version":1,"generation":10,"registered":true,"manifest-consistent":true,"held":false,"teardown-closed":false,"in-flight":0,"quiescent":false},"rcu-barrier":{"schema-version":1,"generation":7,"owner-thread-id":0,"held":false,"complete":true,"registered-readers":2,"active-readers":0,"admissions-in-flight":0,"pending-callbacks":0,"drain-active":false,"quiescent":false},"bh-timer-barrier":{"schema-version":2,"generation":7,"owner-thread-id":0,"held":false,"complete":true,"bottom-halves-complete":true,"timers-complete":true,"admissions-in-flight":0,"bottom-half-count":4,"pending-bottom-halves":2,"scheduled-bottom-halves":1,"active-bottom-half-callbacks":0,"pending-timers":3,"active-timer-callbacks":0,"aio-context-count":2,"active-aio-polls":0,"active-aio-dispatches":0,"queued-coroutines":1,"aio-handler-count":3,"active-aio-handler-callbacks":0,"aio-contexts-complete":true,"aio-handlers-complete":true,"quiescent":false},"block-barrier":{"schema-version":2,"generation":4,"owner-thread-id":0,"graph-barrier-generation":6,"graph-mutation-generation":9,"held-graph-mutation-generation":0,"graph-owner-thread-id":0,"held":false,"graph-held":false,"graph-writer-active":false,"graph-waiting-writers":0,"graph-stable":false,"complete":true,"backend-count":3,"rooted-backends":2,"writable-backends":2,"quiesced-rooted-backends":0,"in-flight":0,"quiescent":false},"rollback-complete":true,"ready":false}}"#,
    ]);
    let audit = stream.audit_handle();
    let mut client = QmpClient::connect(stream)?;
    ...
    for response in [
        r#"{"return":{"schema-version":6,"generation":4,"outcome":"draining","transaction-active":true,"required-proofs":511,"acknowledged-proofs":23,"missing-proofs":488,"plugin-barrier":{"schema-version":1,"generation":8,"registered":true,"manifest-consistent":true,"held":true,"teardown-closed":false,"in-flight":0,"quiescent":true},"rcu-barrier":{"schema-version":1,"generation":6,"owner-thread-id":44,"held":true,"complete":true,"registered-readers":2,"active-readers":0,"admissions-in-flight":0,"pending-callbacks":0,"drain-active":false,"quiescent":true},"bh-timer-barrier":{"schema-version":2,"generation":6,"owner-thread-id":44,"held":true,"complete":true,"bottom-halves-complete":true,"timers-complete":true,"admissions-in-flight":0,"bottom-half-count":4,"pending-bottom-halves":2,"scheduled-bottom-halves":1,"active-bottom-half-callbacks":0,"pending-timers":3,"active-timer-callbacks":0,"aio-context-count":2,"active-aio-polls":0,"active-aio-dispatches":0,"queued-coroutines":1,"aio-handler-count":3,"active-aio-handler-callbacks":0,"aio-contexts-complete":true,"aio-handlers-complete":true,"quiescent":true},"block-barrier":{"schema-version":2,"generation":4,"owner-thread-id":44,"graph-barrier-generation":5,"graph-mutation-generation":9,"held-graph-mutation-generation":9,"graph-owner-thread-id":44,"held":true,"graph-held":true,"graph-writer-active":false,"graph-waiting-writers":0,"graph-stable":true,"complete":true,"backend-count":3,"rooted-backends":2,"writable-backends":2,"quiesced-rooted-backends":2,"in-flight":0,"quiescent":true},"rollback-complete":false,"ready":false}}"#,
        r#"{"return":{"schema-version":6,"generation":4,"outcome":"blocked","transaction-active":false,"required-proofs":511,"acknowledged-proofs":7,"missing-proofs":504,"plugin-barrier":{"schema-version":1,"generation":9,"registered":true,"manifest-consistent":true,"held":false,"teardown-closed":false,"in-flight":0,"quiescent":false},"rcu-barrier":{"schema-version":1,"generation":7,"owner-thread-id":0,"held":false,"complete":true,"registered-readers":2,"active-readers":0,"admissions-in-flight":0,"pending-callbacks":0,"drain-active":false,"quiescent":false},"block-barrier":{"schema-version":2,"generation":4,"owner-thread-id":0,"graph-barrier-generation":6,"graph-mutation-generation":9,"held-graph-mutation-generation":0,"graph-owner-thread-id":0,"held":false,"graph-held":false,"graph-writer-active":false,"graph-waiting-writers":0,"graph-stable":false,"complete":true,"backend-count":3,"rooted-backends":2,"writable-backends":2,"quiesced-rooted-backends":0,"in-flight":0,"quiescent":false},"rollback-complete":true,"ready":false}}"#,
        r#"{"return":{"schema-version":6,"generation":4,"outcome":"blocked","transaction-active":false,"required-proofs":511,"acknowledged-proofs":39,"missing-proofs":472,"plugin-barrier":{"schema-version":1,"generation":9,"registered":true,"manifest-consistent":true,"held":false,"teardown-closed":false,"in-flight":0,"quiescent":false},"rcu-barrier":{"schema-version":1,"generation":7,"owner-thread-id":0,"held":false,"complete":true,"registered-readers":2,"active-readers":0,"admissions-in-flight":0,"pending-callbacks":0,"drain-active":false,"quiescent":false},"block-barrier":{"schema-version":2,"generation":4,"owner-thread-id":0,"graph-barrier-generation":6,"graph-mutation-generation":9,"held-graph-mutation-generation":0,"graph-owner-thread-id":0,"held":false,"graph-held":false,"graph-writer-active":false,"graph-waiting-writers":0,"graph-stable":false,"complete":true,"backend-count":3,"rooted-backends":2,"writable-backends":2,"quiesced-rooted-backends":0,"in-flight":0,"quiescent":false},"rollback-complete":true,"ready":false}}"#,
        r#"{"return":{"schema-version":2,"generation":4,"outcome":"blocked","transaction-active":false,"required-proofs":511,"acknowledged-proofs":23,"missing-proofs":488,"plugin-barrier":{"schema-version":1,"generation":9,"registered":true,"manifest-consistent":true,"held":true,"teardown-closed":false,"in-flight":0,"quiescent":true},"rcu-barrier":{"schema-version":1,"generation":6,"owner-thread-id":44,"held":true,"complete":true,"registered-readers":2,"active-readers":0,"admissions-in-flight":0,"pending-callbacks":0,"drain-active":false,"quiescent":true},"block-barrier":{"schema-version":2,"generation":4,"owner-thread-id":0,"graph-barrier-generation":6,"graph-mutation-generation":9,"held-graph-mutation-generation":0,"graph-owner-thread-id":0,"held":false,"graph-held":false,"graph-writer-active":false,"graph-waiting-writers":0,"graph-stable":false,"complete":true,"backend-count":3,"rooted-backends":2,"writable-backends":2,"quiesced-rooted-backends":0,"in-flight":0,"quiescent":false},"rollback-complete":false,"ready":false}}"#,
        r#"{"return":{"schema-version":2,"generation":4,"outcome":"prepared","transaction-active":true,"required-proofs":511,"acknowledged-proofs":7,"missing-proofs":504,"plugin-barrier":{"schema-version":1,"generation":9,"registered":true,"manifest-consistent":true,"held":true,"teardown-closed":false,"in-flight":0,"quiescent":true},"rcu-barrier":{"schema-version":1,"generation":6,"owner-thread-id":44,"held":true,"complete":true,"registered-readers":2,"active-readers":0,"admissions-in-flight":0,"pending-callbacks":0,"drain-active":false,"quiescent":true},"block-barrier":{"schema-version":2,"generation":4,"owner-thread-id":44,"graph-barrier-generation":5,"graph-mutation-generation":9,"held-graph-mutation-generation":9,"graph-owner-thread-id":44,"held":true,"graph-held":true,"graph-writer-active":false,"graph-waiting-writers":0,"graph-stable":true,"complete":true,"backend-count":3,"rooted-backends":2,"writable-backends":2,"quiesced-rooted-backends":2,"in-flight":0,"quiescent":true},"rollback-complete":false,"ready":true}}"#,
    ] {
        let mut client = QmpClient::connect(scripted_qmp([
            r#"{"QMP":{"version":{},"capabilities":[]}}"#,
            r#"{"return":{}}"#,
