...
fn node_kind(node: &InspectionNode) -> &'static str {
    match node {
        ...
        InspectionNode::Implementation { .. } => "implementation",
...
fn relation_label(relation: InspectionRelation) -> &'static str {
    match relation {
        ...
        InspectionRelation::DeclaresImplementation => "declares-implementation",
        InspectionRelation::ExportsImplementation => "exports-implementation",
        InspectionRelation::ImplementsInterface => "implements-interface",
