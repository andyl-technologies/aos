...
pub use eval::{
    ...
    NativeSuccessStats, NixEval, NixEvalConfig, native_eval_stats, native_fallback_stats,
    native_mode_from_env, native_shadow_stats, native_success_stats, select_evaluator,
