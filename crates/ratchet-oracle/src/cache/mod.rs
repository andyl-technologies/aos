...
pub use persist::{
    ...
    PersistBlobPackHeader, PersistBlobPackTrim, PersistBlobPackTrimError, PersistBlobRecordHeader,
    PersistBlobStore, PersistCache, PersistCachedExpressionNodeValueIndexedLoadError,
