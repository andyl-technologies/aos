...
pub use persist::{
    ...
    PersistBlobIndexError, PersistBlobIndexRebuildPlan, PersistBlobIndexRebuildPlanError,
    PersistBlobIndexStaleEntry, PersistBlobIndexedReadError, PersistBlobIndexedWriteError,
