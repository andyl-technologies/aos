...
pub(in crate::eval::tree_walk) use force_persistence::FirstDemandPersistence;
mod force_subject;
...
impl TreeWalk {
    ...
    pub fn with_options_and_eval_cache(
        ...
        // Raw thunk words are safe weak identities only in the serial,
    ...
    pub(super) fn eval_node_on_current_stack(&mut self, id: IrId) -> Result<Value, TreeWalkError> {
        ...
        self.enter_eval_step(id, node.span)?;
