...
pub struct TreeWalkOptions {
    ...
    pub(crate) max_eval_steps: Option<u64>,
    ...
    pub(crate) enforce_heap_memory_budget: bool,
    pub(crate) option_read_observer: Option<OptionReadObserver>,
...
impl Default for TreeWalkOptions {
    fn default() -> Self {
        Self {
            ...
            enforce_heap_memory_budget: false,
            option_read_observer: None,
