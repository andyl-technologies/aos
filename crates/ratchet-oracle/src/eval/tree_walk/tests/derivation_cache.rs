...
fn assert_derivation_surface_has_input_source(
    surface_name: &str,
    surface: &CachedDerivationSurface,
...
fn assert_derivation_surface_lacks_input_source(
    surface_name: &str,
    surface: &CachedDerivationSurface,
    input_path_in_store: &[u8],
) {
...
fn assert_zero_input_force_hit_preserves_drv_surface(
    persist_prefix: &str,
    ir: &Ir,
    source: &str,
    surface_name: &str,
    ...
    assert!(
        ...
        "cold {surface_name} surface should miss while recording demand"
    );
