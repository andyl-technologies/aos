...
pub use option_access::{OptionReadObservation, OptionReadObserver};
...
pub struct TreeWalk {
    ...
    ///
    /// Moving collection clears this advisory cache before nursery addresses
    /// can be reused; recipes are rebuilt lazily from relocated closures.
