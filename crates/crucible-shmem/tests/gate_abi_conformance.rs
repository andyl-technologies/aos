...
use crucible_shmem::{
    ...
    FINGERPRINT_SAMPLE_SLOT_RESERVED_OFFSET, FRAME_DELIVERY_PENDING, FRAME_DELIVERY_RETAINED,
    FRAME_ENTRY_DATA_OFFSET, FRAME_ENTRY_DELIVERY_ATTEMPTS_OFFSET,
    ...
    FRAME_ENTRY_SEQ_OFFSET, FRAME_ENTRY_SIZE, FRAME_ENTRY_SRC_NODE_OFFSET, FrameEntry,
...
const _: () = assert!(
    FINGERPRINT_SAMPLE_SLOT_CAPTURE_REQUEST_OFFSET == FINGERPRINT_SAMPLE_SLOT_RESERVED_OFFSET
);
