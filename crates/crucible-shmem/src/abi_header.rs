...
use crate::{
    ...
    ADVANCE_STOP_CONDITION_CEILING, ADVANCE_STOP_CONDITION_NEXT_AUTHENTICATED_IDLE,
    ...
    COVERAGE_QUEUE_CAPACITY, DEFAULT_QUEUE_CAPACITY, FRAME_DELIVERY_PENDING,
    FRAME_DELIVERY_RETAINED, FRAME_ENTRY_ALIGN, FRAME_ENTRY_DATA_OFFSET,
    ...
    LAYOUT_TARGET_TRIPLE, MAX_FRAME_DATA, MAX_NODES, MAX_VM_NODES,
    NODE_SLOT_ADVANCE_PUBLICATION_SEQUENCE_OFFSET, NODE_SLOT_ADVANCE_STOP_CONDITION_OFFSET,
    NODE_SLOT_ALIGN, NODE_SLOT_CONTROL_BOUNDARY_ACK_OFFSET,
    NODE_SLOT_CONTROL_BOUNDARY_CAPTURE_REQUEST_OFFSET,
    NODE_SLOT_CONTROL_BOUNDARY_FAULT_COMMAND_FRONTIER_OFFSET, NODE_SLOT_CURRENT_ICOUNT_OFFSET,
    ...
    NODE_SLOT_MAX_ADVANCE_ICOUNT_OFFSET, NODE_SLOT_PAD2_OFFSET, NODE_SLOT_PAD3_OFFSET,
    NODE_SLOT_PAD4_OFFSET, NODE_SLOT_PREEMPTION_ARG0_OFFSET, NODE_SLOT_PREEMPTION_ARG1_OFFSET,
    NODE_SLOT_PREEMPTION_AT_TICK_OFFSET, NODE_SLOT_PREEMPTION_CEILING_TICK_OFFSET,
    NODE_SLOT_PREEMPTION_CONSUMED_SEQUENCE_OFFSET, NODE_SLOT_PREEMPTION_DEADLINE_TICK_OFFSET,
    ...
    NODE_SLOT_TIMER_WITNESS_ARMED_RAW_ICOUNT_OFFSET, NODE_SLOT_TIMER_WITNESS_COMPLETED_OFFSET,
    NODE_SLOT_TIMER_WITNESS_DEADLINE_TICK_OFFSET, NODE_SLOT_TIMER_WITNESS_DEADLINE_PS_OFFSET,
    NODE_SLOT_TIMER_WITNESS_FIRED_EXPIRE_PS_OFFSET,
    NODE_SLOT_TIMER_WITNESS_FIRED_RAW_ICOUNT_OFFSET,
    NODE_SLOT_TIMER_WITNESS_FIRED_VIRTUAL_PS_OFFSET, NODE_SLOT_TIMER_WITNESS_GENERATION_OFFSET,
    NODE_SLOT_TIMER_WITNESS_RESERVED_OFFSET, NODE_SLOT_WAKE_SIGNAL_OFFSET,
    ...
    RING_HEADER_WRITE_IDX_OFFSET, SELECTABLE_REPLY_QUEUE_CAPACITY, SLOT_9P_IO, SLOT_BLK_IO,
    SLOT_NET_ROUTER, STATUS_DONE, STATUS_IDLE, STATUS_RUNNING, WHITEBOX_MARKER_ENTRY_ALIGN,
...
fn emit_frame_entry(out: &mut String) {
    ...
    out.push_str("    _Atomic uint8_t delivery_state;\n");
    out.push_str("    uint8_t pad[CRUCIBLE_SHMEM_FRAME_ENTRY_PAD_LEN];\n");
    out.push_str("    _Atomic uint32_t delivery_attempts;\n");
    out.push_str("    _Atomic uint64_t last_delivery_attempt_icount;\n");
