...
pub use binding_v2::{
    ...
    ClosedPolicyRootSessionV2, ClosedPolicyRootSignerJoinV2, ROOT_EFFECT_ACK_RECORD_BYTES_V1,
    RootEffectAckErrorV1, RootEffectAckV1, StagedClosedPolicyRootBaseV2,
