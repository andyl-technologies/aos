//! Length-delimited codec for destination-slot inventory snapshots.
//!
//! ```text
//! AOSDSI01 | state:1 | flags:1 | reserved:2 | request-id:16 |
...
const MAGIC: &[u8; 8] = b"AOSDSI01";
const DOMAIN: &[u8] = b"aos.sandbox.destination-slot-inventory.v1\0";
