...
content_object_id!(
    ...
    "Identifies one canonical campaign finding with or without candidate occurrences."
);
content_object_id!(
    ...
    "Identifies one durable finding candidate handoff across its current evidence and retention shapes."
);
content_object_id!(
