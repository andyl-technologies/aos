...
/// Maximum candidate bundles returned by one finding-occurrence page.
pub const MAX_CAMPAIGN_FINDING_OCCURRENCE_QUERY_PAGE_ITEMS: u32 = 1;
...
mod finding_occurrences;
pub use finding_occurrences::*;
