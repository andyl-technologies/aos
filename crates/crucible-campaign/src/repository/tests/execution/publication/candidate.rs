...
fn complete_exact_retention_requires_executor_authentication_and_cold_loads_attestation() {
    ...
    .expect("single-candidate finding bundle");
    ...
    .expect("finding bundle");
    let bundle_id = bundle.id().expect("finding bundle ID");
    assert!(matches!(
    ...
    let publication = executor
        ...
        .expect("publish executor-attested bundle");
