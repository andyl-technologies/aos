...
const OBSERVATION_STOP_ATTEMPT_SCHEMA_VERSION: u32 = 4;
const CONTINUATION_INPUT_ATTEMPT_SCHEMA_VERSION: u32 = 7;
const OBSERVATION_CONTINUATION_INPUT_ATTEMPT_SCHEMA_VERSION: u32 = 8;
...
pub(crate) const OBSERVATION_STOP_BRANCH_REQUEST_SCHEMA_VERSION: u32 = 9;
const PROPOSAL_SCHEMA_VERSION: u32 = 2;
const BRANCH_PATH_SCHEMA_VERSION: u32 = 2;
const ATTEMPT_ADMISSION_SCHEMA_VERSION: u32 = 2;
pub(crate) const ATTEMPT_ADMISSION_RETENTION_SCHEMA_VERSION: u32 = 3;
...
const MAX_CONTINUATION_OVERRIDE_DECISIONS: usize = 4_096;
const MAX_CONTINUATION_OVERRIDE_DECISION_BYTES: usize = 1024 * 1024;
const MAX_CONTINUATION_OVERRIDE_BYTES: usize = 32 * 1024 * 1024;
