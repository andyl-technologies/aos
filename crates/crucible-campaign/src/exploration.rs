...
const ATTEMPT_SCHEMA_VERSION: u32 = 9;
pub(crate) const BRANCH_REQUEST_SCHEMA_VERSION: u32 = 10;
const PROPOSAL_SCHEMA_VERSION: u32 = 3;
...
const PLANNER_BEAM_CANDIDATE_SCHEMA_VERSION: u32 = 2;
...
const MAX_CONTINUATION_SELECTIONS: usize = 4_096;
const MAX_CONTINUATION_SELECTION_BYTES: usize = 1024 * 1024;
const MAX_CONTINUATION_SELECTION_BYTES_TOTAL: usize = 32 * 1024 * 1024;
