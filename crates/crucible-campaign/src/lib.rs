...
pub use campaign_service::{
    ...
    CampaignStatusSummary, CampaignTraceKind, CampaignWorldStatus, CreateCampaignRequest,
    ...
    MAX_CAMPAIGN_STATUS_CONTINUATIONS, MAX_CAMPAIGN_TRACE_BYTES, MAX_CAMPAIGN_TRACE_CHUNK_BYTES,
