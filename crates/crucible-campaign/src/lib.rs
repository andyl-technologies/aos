...
pub use campaign_service::{
    ...
    CampaignFindingTriageReplayRole, CampaignGraphEntry, CampaignListEntry, CampaignName,
    CampaignOperationalEvidence, CampaignOperationalStatus, CampaignOperationalStatusProvider,
    CampaignOutcomeCounts, CampaignPlannerEvidence, CampaignPrincipal, CampaignPrincipalAuthorizer,
    CampaignReportEndpoint, CampaignReportSummary, CampaignSemanticStatus, CampaignService,
