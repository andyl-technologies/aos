//! Strict legacy `AOSMSA01` serde model used only by the explicit migration planner.
//!
...
impl ProviderMethodV1 {
    pub(crate) const fn protocol(self) -> SourceProviderMethod {
        match self {
...
#[derive(Clone, Debug, Deserialize, Eq, PartialEq, Serialize)]
#[serde(deny_unknown_fields)]
pub(crate) struct StoredEnvelopeV1 {
    pub(crate) schema: String,
    pub(crate) version: u16,
    pub(crate) record: StoredRecordV1,
}
