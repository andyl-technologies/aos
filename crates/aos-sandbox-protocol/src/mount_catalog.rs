...
/// Bounds Mount 2.0 preparation above the largest authorized Host packet.
pub const MOUNT_CATALOG_PREPARATION_OVERHEAD_BYTES: usize = 32 * 1024;
/// Maximum encoded Mount 2.0 preparation packet accepted before decoding.
...
/// Decodes a bounded Mount 2.0 catalog preparation request.
///
/// # Errors
///
