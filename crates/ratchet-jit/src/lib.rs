...
pub use cranelift::{
    ...
    jit_cranelift_call_finalized_thunk_entry, jit_cranelift_dependency_pin,
...
pub use lower::{
    ...
    AOS_SELECT_IC_FUNCTION_INDEX, AOS_UPDATE_FUNCTION_INDEX, AOS_UPVAL_GET_FUNCTION_INDEX,
    ...
    clif_external_name_for_aos_upval_get, clif_name_for_ir_root,
    ...
    lower_forced_env_get_ir_thunk_body_artifact, lower_forced_upval_get_ir_root_thunk_body,
    lower_forced_upval_get_ir_root_thunk_body_artifact, lower_forced_upval_get_ir_thunk_body,
    lower_forced_upval_get_ir_thunk_body_artifact, lower_has_attr_local_slot_ir_root_thunk_body,
