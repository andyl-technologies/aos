...
//! anti-rollback floors, stale-vs-failed classification, and incremental
//! channel refresh.
...
async fn register(db: &Database, fixture: &common::Fixture) {
