...
//! the Stone & ocean language: white/black foundations, warm stone surfaces,
//! and an ocean-green accent. Geist Sans carries prose and controls; Geist
//! Mono carries code and machine identities. Pages never reference a
//! third-party origin.
