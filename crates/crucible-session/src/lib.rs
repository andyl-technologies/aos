...
pub mod engine {
    pub use crucible::{
        ...
        SearchBudget, SearchStrategy, Seed, SignaturePolicy, SignaturePolicyLevel, SimBackend,
        SimDuration, SimulationBackend, TemporalGraph, TemporalGraphStoreError, VirtualTime,
