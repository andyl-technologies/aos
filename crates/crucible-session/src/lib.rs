...
pub mod engine {
    ...
    pub use crucible::{
        ...
        ExampleScenarioVerifyReport, ExecutionFingerprint,
        FAILURE_TRIAGE_REPLAY_EVIDENCE_SCHEMA_VERSION, FAULT_CAMPAIGN_FAMILY_NAME, FailureCluster,
        ...
        FailureTriageReplayEvidence, FailureTriageResult, FailureTriageSignatureSelfCheck,
        FailureTriageSignatureSelfCheckInput, FailureTriageStoredArtifact, FamilySpace,
        FaultSignalPlan, FindingDiscoveryPath, FindingReproductionArtifact, FingerprintSample,
        GenesisCheckpoint, HAPPY_PATH_SCENARIO_NAME, HostAssertionEvaluator,
        HostAssertionOutcomeKind, HostAssertionViolation, Icount, IrqVector, LinkDef,
        LinkLossProbability, LocalDagStore, LogLevel, MarkerId, MaterializationPolicy,
        ...
        SchedulerEventLogEntry, SchedulerEventLogPayload, SchedulerNodeId, SchedulerQuiescence,
        SchedulingNodeKind, SchedulingPoint, SearchAssertionFinding, SearchBudget,
