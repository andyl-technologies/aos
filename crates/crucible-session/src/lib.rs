...
pub mod engine {
    ...
    pub use crucible::{
        ...
        EventLogOffset, EventLogTime, EventPayload, EventSource, ExampleCorpusError,
        ExampleScenarioVerifyReport, ExecutionFingerprint, FAULT_CAMPAIGN_FAMILY_NAME,
        FailureCluster, FailureClusterFinding, FailureClusterReport, FailureClusterReportFailure,
        ...
        HostAssertionViolation, Icount, IrqVector, LinkDef, LinkLossProbability, LocalDagStore,
        LogLevel, MarkerId, MaterializationPolicy, MaterializationTrigger,
        ...
        PreemptionDecision, PreemptionKind, Properties, Property, QuantumLoop, QuantumOutcome,
        QuantumRequest, ReadyPoint, RecordedAssertionLog, ReplayOracleCheck, ReproductionArtifact,
        ResolvedCodePoint, ResolvedMemPlace, RngDecision, RngStreamId, SHMEM_ABI_VERSION,
        ScenarioDef, ScenarioDefForm, ScenarioFamily, ScenarioSelectableLimits,
        ScenarioSelectables, Schedule, SchedulerError, SchedulerEvaluationBoundaryKind,
        SchedulerEventLogClass, SchedulerEventLogEntry, SchedulerEventLogPayload, SchedulerNodeId,
        SchedulerQuiescence, SchedulingNodeKind, SchedulingPoint, SearchBudget,
        SearchAssertionFinding, SearchDiscoveredFailure, SearchExpansion, SearchFailureOracle,
