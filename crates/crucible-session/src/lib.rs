...
pub mod engine {
    pub use crucible::{
        CRASH_RESTART_SCENARIO_NAME, Configuration, ContentAddressedBlobRef, ContentHash,
        CoverageGuidedFuzzConfig, DagStore, DagStoreError, DebugCheckpointStride,
        DebugCliSurfaceContract, DebugCoordinate, DebugFailureFooterCommand, DebugGdbEndpoint,
        DebugReverseStepGrain, EventAttributeValue, EventDiagnosticPayload, EventLevel,
        EventLogOffset, ExampleCorpusError, ExampleScenarioVerifyReport,
        FAULT_CAMPAIGN_FAMILY_NAME, FailureClusterFinding, FailureClusterReportFormat,
        ...
        FailureTriageStoredArtifact, FingerprintSample, HAPPY_PATH_SCENARIO_NAME, Icount,
        LocalDagStore, NodeId, PARTITION_RECOVERY_SCENARIO_NAME, QuantumLoop, QuantumOutcome,
        QuantumRequest, SHMEM_ABI_VERSION, ScenarioDef, ScenarioDefForm, SchedulerError,
        SchedulerEventLogEntry, SchedulerQuiescence, SearchBudget, SearchStrategy, Seed,
        SignaturePolicy, SignaturePolicyLevel, SimBackend, SimulationBackend, VirtualTime,
        built_in_example_corpus, crash_restart_scenario, fault_campaign_family,
        happy_path_scenario, partition_recovery_scenario, run_fault_campaign_example,
