...
pub mod engine {
    pub use crucible::{
        AssertionId, AssertionPhase, AssertionQuantifierKind, CRASH_RESTART_SCENARIO_NAME,
        Checkpoint, CheckpointKind, ChoiceTag, Configuration, ContentAddressedBlobRef, ContentHash,
        ...
        HAPPY_PATH_SCENARIO_NAME, HostAssertionViolation, Icount, LocalDagStore, MarkerId,
        MaterializationPolicy, MaterializationTrigger, MemoryDagStore, MinimizationConfig,
        MinimizationRun, NodeId, NodeTemplate, OverrideDecision, PARTITION_RECOVERY_SCENARIO_NAME,
        Predicate, QuantumLoop, QuantumOutcome, QuantumRequest, ReadyPoint, ReproductionArtifact,
        ...
        SearchBudget, SearchDiscoveredFailure, SearchFailureOracle,
