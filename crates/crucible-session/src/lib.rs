...
pub mod engine {
    ...
    pub use crucible::{
        ...
        RngStreamId, SHMEM_ABI_VERSION, ScenarioDef, ScenarioDefForm, ScenarioFamily,
        ...
        UnifiedGraphOperationKind, UnifiedGraphOperationReport, VirtualTime, VmArchitecture,
        WhiteBoxPolicy, World, WorldNode, bake, built_in_example_corpus, crash_restart_scenario,
        fault_campaign_family, happy_path_scenario, is_supported_live_world_network_override,
