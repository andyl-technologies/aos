...
pub mod engine {
    pub use crucible::{
        ...
        ChoiceTag, Configuration, ContentAddressedBlobRef, ContentHash, CoverageGuidedCorpusConfig,
        CoverageGuidedCorpusRun, CoverageGuidedFuzzConfig, CoverageGuidedFuzzRun, DagStore,
