...
pub mod engine {
    pub use crucible::{
        ...
        EventAttributeValue, EventDiagnosticPayload, EventLevel, EventLogOffset,
        ExampleCorpusError, ExampleScenarioVerifyReport, FAULT_CAMPAIGN_FAMILY_NAME,
        FailureClusterFinding, FailureClusterReportFormat, FailureClusterReportSet,
        FailureClusteringResult, FailureFindingsLedger,
        ...
        PARTITION_RECOVERY_SCENARIO_NAME, QuantumLoop, QuantumOutcome, QuantumRequest,
        SHMEM_ABI_VERSION, ScenarioDef, ScenarioDefForm, SchedulerError, SchedulerEventLogEntry,
        SchedulerQuiescence, SearchBudget, SearchStrategy, Seed, SignaturePolicy,
        SignaturePolicyLevel, SimBackend, SimDuration, SimulationBackend, TemporalGraph,
        TemporalGraphStoreError, VirtualTime, built_in_example_corpus, crash_restart_scenario,
