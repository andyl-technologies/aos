...
pub mod engine {
    ...
    pub use crucible::{
        ...
        ResolvedFaultTarget, ResolvedMemPlace, RngDecision, RngStreamId, SHMEM_ABI_VERSION,
        ...
        SchedulerQuiescence, SchedulingNodeKind, SchedulingPoint, SearchAssertionFinding,
