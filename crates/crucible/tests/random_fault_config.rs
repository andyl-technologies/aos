...
use crucible::{
    Fault, FaultBandwidthBitsPerSecond, FaultCaps, FaultDuration, FaultPlanEntry,
    FaultRateBasisPoints, FaultSlowdownFactorBasisPoints, FaultWeights, Icount, LinkDef,
    NetworkFault, NodeFault, NodeId, NodeTemplate, RandomFaultConfig, ReadyPoint, Seed,
    SeverityBounds, VmArchitecture, WhiteBoxPolicy, World, WorldNode,
};
...
#[test]
fn random_fault_config_rejects_only_device_weights_until_world_devices_exist() {
    let world = world();
