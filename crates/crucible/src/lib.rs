...
pub use model::{
    ...
    FailureCoverageClass, FailureFirstFailingPoint, FailureKind, FailurePropertyKey,
    ...
    FailureTriageResultIdentity, FamilyParams, FamilySpace, Fault, FaultBandwidthBitsPerSecond,
    ...
    FindingReproductionArtifactError, FramePredicate, FrontierChild, FrontierCoveredChild,
    ...
    MaterializedState, MemPlace, MembershipFault, MemoryCmp, MemoryDagStore, MemoryWidth,
    MinimizationAttempt, MinimizationConfig, MinimizationRun, NetworkCorruptionFault, NetworkFault,
    NinePErrno, NinePFault, NodeBlobRef, NodeClockSkew, NodeCounter, NodeFault, NodeId,
    NodeLifecycle, NodeTemplate, NoveltyRarityGuidanceSignal, OverrideDecision,
