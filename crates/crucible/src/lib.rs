...
pub use model::{
    ...
    FaultDecision, FaultDuration, FaultId, FaultRateBasisPoints, FaultSlowdownFactorBasisPoints,
    FaultState, FaultTag, FindingDiscoveryPath, FindingReproductionArtifact,
