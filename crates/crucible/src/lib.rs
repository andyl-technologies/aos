...
pub use model::{
    ...
    DebugDivergenceCoordinate, DebugGdbEndpoint, DebugGdbstubChannel, DebugGdbstubStepPolicy,
    DebugGotoReport, DebugGotoRequest, DebugGuestEdit, DebugGuestEditKind, DebugMultiVcpuPolicy,
    ...
    GuidanceSignalInput, GuidanceSignalKind, GuidanceSignalWeight, Icount, IoEventKind, IrqVector,
    LinkDef, LinkId, LinkLossProbability, LocalDagStore, MAX_APP_RANDOM_SAMPLES_PER_DRAW,
    MAX_FAILURE_TRIAGE_REPLAY_EVIDENCE_BYTES, MAX_MINIMIZATION_CANDIDATE_WORK_BYTES,
    MAX_MINIMIZATION_CANDIDATES, MIN_LINK_LATENCY, MarkerId, MaterializationPolicy,
    MaterializationTrigger, MaterializedSearchMutation, MaterializedSearchPlan, MaterializedState,
    MemPlace, MemoryCmp, MemoryDagStore, MemoryWidth, MinimizationAttempt, MinimizationConfig,
    ...
    reduce, run_adaptive_strategy_selection, try_step,
};
...
pub use scheduler::{
    ...
    EventLevel, EventLog, EventLogAssertionProximityProjection,
