...
pub use model::{
    ...
    FaultId, FaultRateBasisPoints, FaultSlowdownFactorBasisPoints, FaultState, FaultTag,
    ...
    ReadyPoint, RegexProgram, ReplayOracleCheck, ReproductionArtifact, ReproductionReplay,
