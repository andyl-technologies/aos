...
pub use model::{
    ...
    CoverageGuidanceSignal, CoverageGuidedFuzzConfig, CoverageGuidedFuzzIteration,
    CoverageGuidedFuzzRun, CowDeltaKind, CowDeltaRef, CowSharingStats, DEFAULT_APP_RANDOM_DRAW_CAP,
    DagStore, DagStoreError, DagStoreReproductionArtifact, Decision, DecisionRngState,
