...
pub use scheduler::{
    ...
    EventLog, EventLogCausalDivergencePoint, EventLogCausalProjection,
    EventLogCausalProjectionEntry, EventLogDeterminismComparison, EventLogDeterminismMismatch,
