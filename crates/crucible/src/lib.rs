...
pub use model::{
    ...
    DebugAttachRequest, DebugGdbEndpoint, DebugGdbstubChannel, DebugReadOnlyCheckpointFootprint,
    DebugReadOnlyInspectionFootprint, DebugReadOnlyInspectionKind, DebugReadOnlyInspectionReport,
    DebugReadOnlyInspectionRequest, Decision, DecisionRngState, DeliveryOrderDecision, DeviceId,
