...
pub use model::{
    ...
    EventSequenceKey, EventSequenceState, FailureCausalCone, FailureCoverageClass,
    FailureFirstFailingPoint, FailureKind, FailurePropertyKey, FailurePropertyViolationRecord,
