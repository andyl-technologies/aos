...
pub use model::{
    ...
    DebugBreakpointRequest, DebugBreakpointTarget, DebugGdbEndpoint, DebugGdbstubChannel,
    ...
    EventSequenceState, FamilyParams, FamilySpace, Fault, FaultBandwidthBitsPerSecond, FaultCaps,
    FaultDecision, FaultDensity, FaultDensityRange, FaultDuration, FaultId, FaultPlan,
