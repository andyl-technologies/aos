...
impl SingleScheduler {
    ...
    pub fn network_checkpoint(&self) -> SchedulerNetworkCheckpoint {
        SchedulerNetworkCheckpoint {
            links: self
                ...
                .collect(),
            rng_positions: self.world_network_rng_positions.clone(),
    ...
    pub fn restore_network_checkpoint(
        ...
        if checkpoint.rng_positions.keys().collect::<BTreeSet<_>>()
            != staged
        ...
        staged.world_network_rng_positions = checkpoint.rng_positions.clone();
