//! QEMU plugin-side deterministic test double.
...
use crate::{
    ...
    FingerprintSample, GdbAttachInfo, GdbListen, Icount, NodeId, SchedulerError, SchedulerNodeId,
