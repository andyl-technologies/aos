...
//! [`semantics_v1`] is the pure, controller-reusable definition of each signed
//! host verb, target, and argument commitment. It intentionally exposes no
//! node-local catalog or kernel-identity type.
