...
const fn command_index(command: SessionCommandKind) -> u64 {
    match command {
        ...
        SessionCommandKind::InjectFault => 11,
        SessionCommandKind::HealFault => 12,
        SessionCommandKind::SetBreakpoint => 13,
        SessionCommandKind::RemoveBreakpoint => 14,
        SessionCommandKind::CreateSavepoint => 15,
        SessionCommandKind::Fork => 16,
        SessionCommandKind::Query => 17,
        SessionCommandKind::Snapshot => 18,
        SessionCommandKind::AttachGdb => 19,
        SessionCommandKind::DebugGoto => 20,
