...
use crucible_api::{
    ...
    QuiescentLifecycleLoop, RESUME_OBSERVATION_SOURCE_MAX_BYTES, RESUME_REPLAY_CLOSURE_MAX_BYTES,
    ...
    ResumeReplayClosure, ResumeReplayClosureValidationError, ResumeSessionRequest,
