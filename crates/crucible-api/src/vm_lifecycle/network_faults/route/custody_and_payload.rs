...
#[cfg(test)]
// crucible-lint: allow rust-allow -- the test adapter preserves the production custody context while supplying default limits.
#[allow(
    clippy::too_many_arguments,
    reason = "the test adapter preserves every authenticated custody input"
)]
