...
fn custody_waits_for_contact_then_conserves_shared_capacity() {
    ...
    assert_eq!(service.defer_until, Some(112_000));
    ...
    assert_eq!(second.defer_until, Some(114_000));
...
fn custody_selects_and_reserves_a_bounded_multihop_contact_route() {
    ...
    second.start_ticks = 120_000;
    second.end_ticks = 220_000;
    ...
    *intervals = vec![first, direct, second];
    ...
    assert_eq!(reserved.defer_until, Some(110_000));
    ...
    assert_eq!(reserved.defer_until, Some(132_000));
...
fn custody_checkpoint_rejects_broken_contact_graph_joins() {
    ...
    let reservation = &mut service_before_enqueue
        ...
        .unwrap_or_else(|| panic!("custody queue"))
        .reservations[0];
    reservation.enqueue_ticks = 111_000;
    reservation.expiry_ticks = 1_111_000;
    assert!(
