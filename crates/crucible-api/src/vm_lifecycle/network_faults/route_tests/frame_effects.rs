...
fn frame_effect_variants_mutate_production_frame_outcomes() {
    ...
    assert_eq!(profile.latency_delta_ticks(), -40);
    ...
    assert_eq!(propagation.additional_delay_ticks(), 88);
    ...
    assert_eq!(access.additional_delay_ticks(), 104);
    ...
    assert!(jitter.additional_delay_ticks() <= 136);
    ...
    assert_eq!(duplicate.duplicate_gaps_ticks(), &[56, 112]);
    ...
    assert_eq!(reorder.additional_delay_ticks(), 152);
