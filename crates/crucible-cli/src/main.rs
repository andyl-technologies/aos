...
struct ResumeArgs {
    ...
    #[arg(long, value_name = "dur")]
    max_virtual_time: Option<String>,
    /// Pause at the resumed boundary for control commands.
    #[arg(long, action = ArgAction::SetTrue)]
    interactive: bool,
    /// Stream live status.
    #[arg(long, action = ArgAction::SetTrue)]
...
struct SaveRecordingLifecycleLoop {
    ...
    marker_node: Option<crucible::NodeId>,
...
impl SaveRecordingLifecycleLoop {
    fn new(fixture: SaveRecordingFixture, marker_node: Option<crucible::NodeId>) -> Self {
        Self {
            fixture,
            marker_node,
...
"#
    ...
    fn write_marker_selector_scenario_with_policy(
        ...
        let world = ::crucible::World::from_nodes(vec![::crucible::WorldNode {
            ...
            arch: ::crucible::NodeTemplate::DEFAULT_ARCH,
            memory_mib: ::crucible::NodeTemplate::DEFAULT_MEMORY_MIB,
            cmdline: String::from("crucible-marker-selector=1"),
            ready_point: ::crucible::ReadyPoint::FixedIcount {
                ...
                let control_plane = LifecycleControlPlane::new(
                    ...
                    move |_scenario: &crucible::ScenarioDef, _seed| match fixture.clone() {
                        ...
                        ResumeRecordingFixture::PropertyViolation { assertion } => {
                            ResumeRecordingLifecycleLoop::with_property_violation(
                                frontier, assertion,
                            )
                        }
                    },
    ...
    fn cli_save_selector_proof_rejects_invalid_breakpoint_evidence() -> Result<(), Box<dyn Error>> {
        ...
        assert_eq!(
            ...
            crucible::Predicate::guest_marker(crucible::MarkerId::from_name(
                SAVE_DOUBLE_GUEST_MARKER
            ))
        );
    ...
    -> Result<(), Box<dyn Error>> {
        ...
        let no_budget =
            Cli::parse_from(["crucible", "resume", &reference, "--until", "virtual-time"]);
