...
impl TreeWalk {
    pub(super) fn materialize_fetch_tarball_store_path(
        &mut self,
        id: IrId,
        span: Span,
        url: &[u8],
    ...
    pub(super) fn fetch_tarball_store_path_matches_digest(
        &mut self,
        id: IrId,
        span: Span,
        store_path: &[u8],
    ...
    pub(super) fn validate_fetch_tarball_store_path_digest(
        &mut self,
        id: IrId,
        span: Span,
        url: &[u8],
    ...
    pub(super) fn fetch_tarball_temp_store_path(
        id: IrId,
        span: Span,
        url: &[u8],
        parent: &Path,
    ...
    pub(super) fn remove_fetch_tarball_temp_path(path: &Path) {
    ...
    pub(super) fn copy_fetch_tarball_tree(source: &Path, target: &Path) -> io::Result<()> {
    ...
    pub(super) fn fetch_tarball_error(
        id: IrId,
        span: Span,
        url: &[u8],
