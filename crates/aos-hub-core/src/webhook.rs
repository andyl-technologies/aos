...
pub const SUPPORTED_EVENT_TYPES: &[&str] = &[
    ...
    "topology.gateway.revised",
    "topology.gateway.enabled",
    "topology.gateway.disabled",
    "topology.gateway.reconciled",
    "topology.gateway.deleted",
    "topology.route.created",
    "topology.route.revised",
    "topology.route.reconciled",
    "topology.route.deleted",
    ...
    "topology.endpoint.created",
    "topology.endpoint.generation_staged",
    "topology.endpoint.generation_activated",
    "topology.endpoint.reconciled",
    "topology.endpoint.deleted",
];
