...
pub enum Permission {
    ...
    RegistryConfigure,
    /// Manage bindings, buckets, and cache stores.
    StorageManage,
    ...
    BindingRead,
    /// Create, revise, and retire bindings.
    BindingManage,
    /// Grant a binding to another authorization scope.
    BindingGrant,
...
impl Permission {
    ...
    pub fn as_str(self) -> &'static str {
        match self {
            ...
            Permission::BindingRead => "binding.read",
            Permission::BindingManage => "binding.manage",
            Permission::BindingGrant => "binding.grant",
            ...
            Permission::NetworkPolicyRead => "network_policy.read",
            Permission::NetworkPolicyManage => "network_policy.manage",
            Permission::NetworkPolicyGrant => "network_policy.grant",
            Permission::EndpointRead => "endpoint.read",
            Permission::EndpointManage => "endpoint.manage",
            Permission::EndpointGrant => "endpoint.grant",
            Permission::GatewayRead => "gateway.read",
            Permission::GatewayManage => "gateway.manage",
            Permission::GatewayGrant => "gateway.grant",
    ...
    pub fn parse(value: &str) -> Option<Self> {
        match value {
            ...
            "binding.read" => Some(Self::BindingRead),
            "binding.manage" => Some(Self::BindingManage),
            "binding.grant" => Some(Self::BindingGrant),
            ...
            "network_policy.read" => Some(Self::NetworkPolicyRead),
            "network_policy.manage" => Some(Self::NetworkPolicyManage),
            "network_policy.grant" => Some(Self::NetworkPolicyGrant),
            "endpoint.read" => Some(Self::EndpointRead),
            "endpoint.manage" => Some(Self::EndpointManage),
            "endpoint.grant" => Some(Self::EndpointGrant),
            "gateway.read" => Some(Self::GatewayRead),
            "gateway.manage" => Some(Self::GatewayManage),
            "gateway.grant" => Some(Self::GatewayGrant),
