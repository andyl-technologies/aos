...
fn selection_authenticates_pin_and_checkpoint_and_survives_restart() {
    ...
    assert_eq!(
        ...
        .to_hex(),
        // Version-3 snapshots bind the version-2 indexed budget ledger and the
        // current authenticated checkpoint fixture's execution basis.
        "50b9b3b9c333e2645c3495e7cd784241d4ce8e6d3b249f5f64b9cae48fecbe19"
    );
