...
//!
//! Retired single-node roots are rejected. Only canonical production roots
...
impl ExactCheckpointStore {
    ...
    /// method returns. Retired single-node roots fail closed as unsupported.
    ///
    /// # Errors
    ///
    /// Returns an error for a retired root version or any absence, corruption,
