...
mod tests {
    ...
    use crucible_campaign::{
        ...
        Finding, FindingCandidateBundleId, FindingCandidateOccurrenceSet, FindingExactPins,
        FindingKind, FindingOccurrenceSet, FindingSignature, MerkleMap, ObservationId,
    ...
    fn finding_for_test(occurrence_root: ContentId) -> Finding {
        ...
        let candidate_bundle = FindingCandidateBundleId::parse(&format!(
            ...
            ContentId::for_bytes(ObjectKind::Finding, 5, b"finding-export-candidate").encode()
        ))
