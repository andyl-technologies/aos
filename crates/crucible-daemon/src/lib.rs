...
pub use crucible_artifact::{
    ...
    CRUCIBLE_REPRODUCTION_PAYLOAD_SCHEMA_V2, CRUCIBLE_SCENARIO_PAYLOAD_SCHEMA_V1,
    CRUCIBLE_SCENARIO_PAYLOAD_SCHEMA_V2, CrucibleArtifactError, CrucibleCampaignArtifactStore,
