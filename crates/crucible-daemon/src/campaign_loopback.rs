...
//!
//! ```text
//! CampaignLoopbackFrameV6 = magic[8] | kind:u8 | reserved[3] |
...
use crucible_campaign::{
    ...
    GetCampaignResponse, MAX_CAMPAIGN_SERVICE_MESSAGE_BYTES, QueryCampaignGraphRequest,
...
const FRAME_MAGIC: &[u8; 8] = b"CRUCCS06";
